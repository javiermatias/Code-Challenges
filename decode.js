! function(e) {
    ...
    (function(e) {
        ! function(e, t) {
            ...
            a.isBN = function(e) {
                ...
                var n, i, a = 0;
                for (r = e.length - 6, n = 0; r >= t; r -= 6) i = s(e, r, r + 6), this.words[n] |= i << a & 67108863, this.words[n + 1] |= i >>> 26 - a & 4194303, (a += 24) >= 26 && (a -= 26, n++);
                r + 6 !== t && (i = s(e, t, r + 6), this.words[n] |= i << a & 67108863, this.words[n + 1] |= i >>> 26 - a & 4194303), this.strip()
            }, a.prototype._parseBase = function(e, t, r) {
                this.words = [0], this.length = 1;
                for (var n = 0, i = 1; i <= 67108863; i *= t) n++;
                n--, i = i / t | 0;
                for (var a = e.length - r, o = a % n, s = Math.min(a, a - o) + r, c = 0, u = r; u < s; u += n) c = f(e, u, u + n, t), this.imuln(i), this.words[0] + c < 67108864 ? this.words[0] += c : this._iaddn(c);
                if (0 !== o) {
                    var h = 1;
            ...
            function d(e, t, r) {
                ...
                for (var c = 1; c < n; c++) {
                    for (var u = f >>> 26, h = 67108863 & f, d = Math.min(c, t.length - 1), l = Math.max(0, c - e.length + 1); l <= d; l++) {
                        var p = c - l | 0;
                        u += (o = (i = 0 | e.words[p]) * (a = 0 | t.words[l]) + h) / 67108864 | 0, h = 67108863 & o
                    }
                    r.words[c] = 0 | h, f = 0 | u
                }
            ...
            a.prototype.toString = function(e, t) {
                ...
                if (e = e || 10, t = 0 | t || 1, 16 === e || "hex" === e) {
                    ...
                    for (var i = 0, a = 0, o = 0; o < this.length; o++) {
                        ...
                        r = 0 !== (a = s >>> 24 - i & 16777215) || o !== this.length - 1 ? c[6 - f.length] + f + r : f + r, (i += 2) >= 26 && (i -= 26, o--)
                    }
                ...
                if (f) {
                    ...
                    for (s = 0; !u.isZero(); s++) o = u.andln(255), u.iushrn(8), c[a - s - 1] = o
                }
                return c
            ...
            var l = function(e, t, r) {
                ...
                var me = (c + (n = Math.imul(h, U)) | 0) + ((8191 & (i = (i = Math.imul(h, F)) + Math.imul(d, U) | 0)) << 13) | 0;
                c = ((a = Math.imul(d, F)) + (i >>> 13) | 0) + (me >>> 26) | 0, me &= 67108863, n = Math.imul(p, U), i = (i = Math.imul(p, F)) + Math.imul(b, U) | 0, a = Math.imul(b, F);
                var ge = (c + (n = n + Math.imul(h, K) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, W) | 0) + Math.imul(d, K) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, W) | 0) + (i >>> 13) | 0) + (ge >>> 26) | 0, ge &= 67108863, n = Math.imul(g, U), i = (i = Math.imul(g, F)) + Math.imul(y, U) | 0, a = Math.imul(y, F), n = n + Math.imul(p, K) | 0, i = (i = i + Math.imul(p, W) | 0) + Math.imul(b, K) | 0, a = a + Math.imul(b, W) | 0;
                var ye = (c + (n = n + Math.imul(h, Y) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, X) | 0) + Math.imul(d, Y) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, X) | 0) + (i >>> 13) | 0) + (ye >>> 26) | 0, ye &= 67108863, n = Math.imul(w, U), i = (i = Math.imul(w, F)) + Math.imul(_, U) | 0, a = Math.imul(_, F), n = n + Math.imul(g, K) | 0, i = (i = i + Math.imul(g, W) | 0) + Math.imul(y, K) | 0, a = a + Math.imul(y, W) | 0, n = n + Math.imul(p, Y) | 0, i = (i = i + Math.imul(p, X) | 0) + Math.imul(b, Y) | 0, a = a + Math.imul(b, X) | 0;
                var ve = (c + (n = n + Math.imul(h, G) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, Z) | 0) + Math.imul(d, G) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, Z) | 0) + (i >>> 13) | 0) + (ve >>> 26) | 0, ve &= 67108863, n = Math.imul(M, U), i = (i = Math.imul(M, F)) + Math.imul(k, U) | 0, a = Math.imul(k, F), n = n + Math.imul(w, K) | 0, i = (i = i + Math.imul(w, W) | 0) + Math.imul(_, K) | 0, a = a + Math.imul(_, W) | 0, n = n + Math.imul(g, Y) | 0, i = (i = i + Math.imul(g, X) | 0) + Math.imul(y, Y) | 0, a = a + Math.imul(y, X) | 0, n = n + Math.imul(p, G) | 0, i = (i = i + Math.imul(p, Z) | 0) + Math.imul(b, G) | 0, a = a + Math.imul(b, Z) | 0;
                var we = (c + (n = n + Math.imul(h, $) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, ee) | 0) + Math.imul(d, $) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, ee) | 0) + (i >>> 13) | 0) + (we >>> 26) | 0, we &= 67108863, n = Math.imul(A, U), i = (i = Math.imul(A, F)) + Math.imul(x, U) | 0, a = Math.imul(x, F), n = n + Math.imul(M, K) | 0, i = (i = i + Math.imul(M, W) | 0) + Math.imul(k, K) | 0, a = a + Math.imul(k, W) | 0, n = n + Math.imul(w, Y) | 0, i = (i = i + Math.imul(w, X) | 0) + Math.imul(_, Y) | 0, a = a + Math.imul(_, X) | 0, n = n + Math.imul(g, G) | 0, i = (i = i + Math.imul(g, Z) | 0) + Math.imul(y, G) | 0, a = a + Math.imul(y, Z) | 0, n = n + Math.imul(p, $) | 0, i = (i = i + Math.imul(p, ee) | 0) + Math.imul(b, $) | 0, a = a + Math.imul(b, ee) | 0;
                var _e = (c + (n = n + Math.imul(h, re) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, ne) | 0) + Math.imul(d, re) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, ne) | 0) + (i >>> 13) | 0) + (_e >>> 26) | 0, _e &= 67108863, n = Math.imul(R, U), i = (i = Math.imul(R, F)) + Math.imul(T, U) | 0, a = Math.imul(T, F), n = n + Math.imul(A, K) | 0, i = (i = i + Math.imul(A, W) | 0) + Math.imul(x, K) | 0, a = a + Math.imul(x, W) | 0, n = n + Math.imul(M, Y) | 0, i = (i = i + Math.imul(M, X) | 0) + Math.imul(k, Y) | 0, a = a + Math.imul(k, X) | 0, n = n + Math.imul(w, G) | 0, i = (i = i + Math.imul(w, Z) | 0) + Math.imul(_, G) | 0, a = a + Math.imul(_, Z) | 0, n = n + Math.imul(g, $) | 0, i = (i = i + Math.imul(g, ee) | 0) + Math.imul(y, $) | 0, a = a + Math.imul(y, ee) | 0, n = n + Math.imul(p, re) | 0, i = (i = i + Math.imul(p, ne) | 0) + Math.imul(b, re) | 0, a = a + Math.imul(b, ne) | 0;
                var Se = (c + (n = n + Math.imul(h, ae) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, oe) | 0) + Math.imul(d, ae) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, oe) | 0) + (i >>> 13) | 0) + (Se >>> 26) | 0, Se &= 67108863, n = Math.imul(P, U), i = (i = Math.imul(P, F)) + Math.imul(B, U) | 0, a = Math.imul(B, F), n = n + Math.imul(R, K) | 0, i = (i = i + Math.imul(R, W) | 0) + Math.imul(T, K) | 0, a = a + Math.imul(T, W) | 0, n = n + Math.imul(A, Y) | 0, i = (i = i + Math.imul(A, X) | 0) + Math.imul(x, Y) | 0, a = a + Math.imul(x, X) | 0, n = n + Math.imul(M, G) | 0, i = (i = i + Math.imul(M, Z) | 0) + Math.imul(k, G) | 0, a = a + Math.imul(k, Z) | 0, n = n + Math.imul(w, $) | 0, i = (i = i + Math.imul(w, ee) | 0) + Math.imul(_, $) | 0, a = a + Math.imul(_, ee) | 0, n = n + Math.imul(g, re) | 0, i = (i = i + Math.imul(g, ne) | 0) + Math.imul(y, re) | 0, a = a + Math.imul(y, ne) | 0, n = n + Math.imul(p, ae) | 0, i = (i = i + Math.imul(p, oe) | 0) + Math.imul(b, ae) | 0, a = a + Math.imul(b, oe) | 0;
                var Me = (c + (n = n + Math.imul(h, fe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, ce) | 0) + Math.imul(d, fe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, ce) | 0) + (i >>> 13) | 0) + (Me >>> 26) | 0, Me &= 67108863, n = Math.imul(j, U), i = (i = Math.imul(j, F)) + Math.imul(N, U) | 0, a = Math.imul(N, F), n = n + Math.imul(P, K) | 0, i = (i = i + Math.imul(P, W) | 0) + Math.imul(B, K) | 0, a = a + Math.imul(B, W) | 0, n = n + Math.imul(R, Y) | 0, i = (i = i + Math.imul(R, X) | 0) + Math.imul(T, Y) | 0, a = a + Math.imul(T, X) | 0, n = n + Math.imul(A, G) | 0, i = (i = i + Math.imul(A, Z) | 0) + Math.imul(x, G) | 0, a = a + Math.imul(x, Z) | 0, n = n + Math.imul(M, $) | 0, i = (i = i + Math.imul(M, ee) | 0) + Math.imul(k, $) | 0, a = a + Math.imul(k, ee) | 0, n = n + Math.imul(w, re) | 0, i = (i = i + Math.imul(w, ne) | 0) + Math.imul(_, re) | 0, a = a + Math.imul(_, ne) | 0, n = n + Math.imul(g, ae) | 0, i = (i = i + Math.imul(g, oe) | 0) + Math.imul(y, ae) | 0, a = a + Math.imul(y, oe) | 0, n = n + Math.imul(p, fe) | 0, i = (i = i + Math.imul(p, ce) | 0) + Math.imul(b, fe) | 0, a = a + Math.imul(b, ce) | 0;
                var ke = (c + (n = n + Math.imul(h, he) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, de) | 0) + Math.imul(d, he) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, de) | 0) + (i >>> 13) | 0) + (ke >>> 26) | 0, ke &= 67108863, n = Math.imul(D, U), i = (i = Math.imul(D, F)) + Math.imul(q, U) | 0, a = Math.imul(q, F), n = n + Math.imul(j, K) | 0, i = (i = i + Math.imul(j, W) | 0) + Math.imul(N, K) | 0, a = a + Math.imul(N, W) | 0, n = n + Math.imul(P, Y) | 0, i = (i = i + Math.imul(P, X) | 0) + Math.imul(B, Y) | 0, a = a + Math.imul(B, X) | 0, n = n + Math.imul(R, G) | 0, i = (i = i + Math.imul(R, Z) | 0) + Math.imul(T, G) | 0, a = a + Math.imul(T, Z) | 0, n = n + Math.imul(A, $) | 0, i = (i = i + Math.imul(A, ee) | 0) + Math.imul(x, $) | 0, a = a + Math.imul(x, ee) | 0, n = n + Math.imul(M, re) | 0, i = (i = i + Math.imul(M, ne) | 0) + Math.imul(k, re) | 0, a = a + Math.imul(k, ne) | 0, n = n + Math.imul(w, ae) | 0, i = (i = i + Math.imul(w, oe) | 0) + Math.imul(_, ae) | 0, a = a + Math.imul(_, oe) | 0, n = n + Math.imul(g, fe) | 0, i = (i = i + Math.imul(g, ce) | 0) + Math.imul(y, fe) | 0, a = a + Math.imul(y, ce) | 0, n = n + Math.imul(p, he) | 0, i = (i = i + Math.imul(p, de) | 0) + Math.imul(b, he) | 0, a = a + Math.imul(b, de) | 0;
                var Ee = (c + (n = n + Math.imul(h, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(h, be) | 0) + Math.imul(d, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(d, be) | 0) + (i >>> 13) | 0) + (Ee >>> 26) | 0, Ee &= 67108863, n = Math.imul(D, K), i = (i = Math.imul(D, W)) + Math.imul(q, K) | 0, a = Math.imul(q, W), n = n + Math.imul(j, Y) | 0, i = (i = i + Math.imul(j, X) | 0) + Math.imul(N, Y) | 0, a = a + Math.imul(N, X) | 0, n = n + Math.imul(P, G) | 0, i = (i = i + Math.imul(P, Z) | 0) + Math.imul(B, G) | 0, a = a + Math.imul(B, Z) | 0, n = n + Math.imul(R, $) | 0, i = (i = i + Math.imul(R, ee) | 0) + Math.imul(T, $) | 0, a = a + Math.imul(T, ee) | 0, n = n + Math.imul(A, re) | 0, i = (i = i + Math.imul(A, ne) | 0) + Math.imul(x, re) | 0, a = a + Math.imul(x, ne) | 0, n = n + Math.imul(M, ae) | 0, i = (i = i + Math.imul(M, oe) | 0) + Math.imul(k, ae) | 0, a = a + Math.imul(k, oe) | 0, n = n + Math.imul(w, fe) | 0, i = (i = i + Math.imul(w, ce) | 0) + Math.imul(_, fe) | 0, a = a + Math.imul(_, ce) | 0, n = n + Math.imul(g, he) | 0, i = (i = i + Math.imul(g, de) | 0) + Math.imul(y, he) | 0, a = a + Math.imul(y, de) | 0;
                var Ae = (c + (n = n + Math.imul(p, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(p, be) | 0) + Math.imul(b, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(b, be) | 0) + (i >>> 13) | 0) + (Ae >>> 26) | 0, Ae &= 67108863, n = Math.imul(D, Y), i = (i = Math.imul(D, X)) + Math.imul(q, Y) | 0, a = Math.imul(q, X), n = n + Math.imul(j, G) | 0, i = (i = i + Math.imul(j, Z) | 0) + Math.imul(N, G) | 0, a = a + Math.imul(N, Z) | 0, n = n + Math.imul(P, $) | 0, i = (i = i + Math.imul(P, ee) | 0) + Math.imul(B, $) | 0, a = a + Math.imul(B, ee) | 0, n = n + Math.imul(R, re) | 0, i = (i = i + Math.imul(R, ne) | 0) + Math.imul(T, re) | 0, a = a + Math.imul(T, ne) | 0, n = n + Math.imul(A, ae) | 0, i = (i = i + Math.imul(A, oe) | 0) + Math.imul(x, ae) | 0, a = a + Math.imul(x, oe) | 0, n = n + Math.imul(M, fe) | 0, i = (i = i + Math.imul(M, ce) | 0) + Math.imul(k, fe) | 0, a = a + Math.imul(k, ce) | 0, n = n + Math.imul(w, he) | 0, i = (i = i + Math.imul(w, de) | 0) + Math.imul(_, he) | 0, a = a + Math.imul(_, de) | 0;
                var xe = (c + (n = n + Math.imul(g, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(g, be) | 0) + Math.imul(y, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(y, be) | 0) + (i >>> 13) | 0) + (xe >>> 26) | 0, xe &= 67108863, n = Math.imul(D, G), i = (i = Math.imul(D, Z)) + Math.imul(q, G) | 0, a = Math.imul(q, Z), n = n + Math.imul(j, $) | 0, i = (i = i + Math.imul(j, ee) | 0) + Math.imul(N, $) | 0, a = a + Math.imul(N, ee) | 0, n = n + Math.imul(P, re) | 0, i = (i = i + Math.imul(P, ne) | 0) + Math.imul(B, re) | 0, a = a + Math.imul(B, ne) | 0, n = n + Math.imul(R, ae) | 0, i = (i = i + Math.imul(R, oe) | 0) + Math.imul(T, ae) | 0, a = a + Math.imul(T, oe) | 0, n = n + Math.imul(A, fe) | 0, i = (i = i + Math.imul(A, ce) | 0) + Math.imul(x, fe) | 0, a = a + Math.imul(x, ce) | 0, n = n + Math.imul(M, he) | 0, i = (i = i + Math.imul(M, de) | 0) + Math.imul(k, he) | 0, a = a + Math.imul(k, de) | 0;
                var Ie = (c + (n = n + Math.imul(w, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(w, be) | 0) + Math.imul(_, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(_, be) | 0) + (i >>> 13) | 0) + (Ie >>> 26) | 0, Ie &= 67108863, n = Math.imul(D, $), i = (i = Math.imul(D, ee)) + Math.imul(q, $) | 0, a = Math.imul(q, ee), n = n + Math.imul(j, re) | 0, i = (i = i + Math.imul(j, ne) | 0) + Math.imul(N, re) | 0, a = a + Math.imul(N, ne) | 0, n = n + Math.imul(P, ae) | 0, i = (i = i + Math.imul(P, oe) | 0) + Math.imul(B, ae) | 0, a = a + Math.imul(B, oe) | 0, n = n + Math.imul(R, fe) | 0, i = (i = i + Math.imul(R, ce) | 0) + Math.imul(T, fe) | 0, a = a + Math.imul(T, ce) | 0, n = n + Math.imul(A, he) | 0, i = (i = i + Math.imul(A, de) | 0) + Math.imul(x, he) | 0, a = a + Math.imul(x, de) | 0;
                var Re = (c + (n = n + Math.imul(M, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(M, be) | 0) + Math.imul(k, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(k, be) | 0) + (i >>> 13) | 0) + (Re >>> 26) | 0, Re &= 67108863, n = Math.imul(D, re), i = (i = Math.imul(D, ne)) + Math.imul(q, re) | 0, a = Math.imul(q, ne), n = n + Math.imul(j, ae) | 0, i = (i = i + Math.imul(j, oe) | 0) + Math.imul(N, ae) | 0, a = a + Math.imul(N, oe) | 0, n = n + Math.imul(P, fe) | 0, i = (i = i + Math.imul(P, ce) | 0) + Math.imul(B, fe) | 0, a = a + Math.imul(B, ce) | 0, n = n + Math.imul(R, he) | 0, i = (i = i + Math.imul(R, de) | 0) + Math.imul(T, he) | 0, a = a + Math.imul(T, de) | 0;
                var Te = (c + (n = n + Math.imul(A, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(A, be) | 0) + Math.imul(x, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(x, be) | 0) + (i >>> 13) | 0) + (Te >>> 26) | 0, Te &= 67108863, n = Math.imul(D, ae), i = (i = Math.imul(D, oe)) + Math.imul(q, ae) | 0, a = Math.imul(q, oe), n = n + Math.imul(j, fe) | 0, i = (i = i + Math.imul(j, ce) | 0) + Math.imul(N, fe) | 0, a = a + Math.imul(N, ce) | 0, n = n + Math.imul(P, he) | 0, i = (i = i + Math.imul(P, de) | 0) + Math.imul(B, he) | 0, a = a + Math.imul(B, de) | 0;
                var Ce = (c + (n = n + Math.imul(R, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(R, be) | 0) + Math.imul(T, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(T, be) | 0) + (i >>> 13) | 0) + (Ce >>> 26) | 0, Ce &= 67108863, n = Math.imul(D, fe), i = (i = Math.imul(D, ce)) + Math.imul(q, fe) | 0, a = Math.imul(q, ce), n = n + Math.imul(j, he) | 0, i = (i = i + Math.imul(j, de) | 0) + Math.imul(N, he) | 0, a = a + Math.imul(N, de) | 0;
                var Pe = (c + (n = n + Math.imul(P, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(P, be) | 0) + Math.imul(B, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(B, be) | 0) + (i >>> 13) | 0) + (Pe >>> 26) | 0, Pe &= 67108863, n = Math.imul(D, he), i = (i = Math.imul(D, de)) + Math.imul(q, he) | 0, a = Math.imul(q, de);
                var Be = (c + (n = n + Math.imul(j, pe) | 0) | 0) + ((8191 & (i = (i = i + Math.imul(j, be) | 0) + Math.imul(N, pe) | 0)) << 13) | 0;
                c = ((a = a + Math.imul(N, be) | 0) + (i >>> 13) | 0) + (Be >>> 26) | 0, Be &= 67108863;
                var Oe = (c + (n = Math.imul(D, pe)) | 0) + ((8191 & (i = (i = Math.imul(D, be)) + Math.imul(q, pe) | 0)) << 13) | 0;
                return c = ((a = Math.imul(q, be)) + (i >>> 13) | 0) + (Oe >>> 26) | 0, Oe &= 67108863, f[0] = me, f[1] = ge, f[2] = ye, f[3] = ve, f[4] = we, f[5] = _e, f[6] = Se, f[7] = Me, f[8] = ke, f[9] = Ee, f[10] = Ae, f[11] = xe, f[12] = Ie, f[13] = Re, f[14] = Te, f[15] = Ce, f[16] = Pe, f[17] = Be, f[18] = Oe, 0 !== c && (f[19] = c, r.length++), r
            };
            ...
            Math.imul || (l = d), a.prototype.mulTo = function(e, t) {
                ...
                for (var o = 1; o < i; o <<= 1)
                    for (var s = o << 1, f = Math.cos(2 * Math.PI / s), c = Math.sin(2 * Math.PI / s), u = 0; u < i; u += s)
                        for (var h = f, d = c, l = 0; l < o; l++) {
                            var p = r[u + l],
                                ...
                                g = n[u + l + o],
                                y = h * m - d * g;
                            g = h * g + d * m, m = y, r[u + l] = p + m, n[u + l] = b + g, r[u + l + o] = p - m, n[u + l + o] = b - g, l !== s && (y = f * h - c * d, d = f * d + c * h, h = y)
                        }
                ...
                var n = 2 * this.guessLen13b(e.length, t.length),
                    ...
                    h = new Array(n),
                    d = r.words;
                d.length = n, this.convert13b(e.words, e.length, o, n), this.convert13b(t.words, t.length, c, n), this.transform(o, a, s, f, n, i), this.transform(c, a, u, h, n, i);
                for (var l = 0; l < n; l++) {
                    var p = s[l] * u[l] - f[l] * h[l];
                    f[l] = s[l] * h[l] + f[l] * u[l], s[l] = p
                }
                return this.conjugate(s, f, n), this.transform(s, f, d, a, n, i), this.conjugate(d, a, n), this.normalize13b(d, n), r.negative = e.negative ^ t.negative, r.length = e.length + t.length, r.strip()
                ...
                for (var i = new a(1), o = new a(0), s = new a(0), f = new a(1), c = 0; t.isEven() && r.isEven();) t.iushrn(1), r.iushrn(1), ++c;
            ...
            g.prototype._tmp = function() {
                ...
                var s = new a(1).toRed(this),
                    ...
                    u = this.m.bitLength();
                for (u = new a(2 * u * u).toRed(this); 0 !== this.pow(u, c).cmp(f);) u.redIAdd(f);
                for (var h = this.pow(u, i), d = this.pow(e, i.addn(1).iushrn(1)), l = this.pow(e, i), p = o; 0 !== l.cmp(s);) {
                ...
                for (0 === f && (f = 26), n = t.length - 1; n >= 0; n--) {
                    for (var c = t.words[n], u = f - 1; u >= 0; u--) {
                        var h = c >> u & 1;
                        i !== r[0] && (i = this.sqr(i)), 0 !== h || 0 !== o ? (o <<= 1, o |= h, (4 === ++s || 0 === n && 0 === u) && (i = this.mul(i, r[o]), s = 0, o = 0)) : s = 0
                    }
                    f = 26
                }
                return i
    ...
    (function(e) {
            ...
            for (var n = [], i = t; i < r;) {
                ...
                if (i + h <= r) switch (h) {
                    case 1:
                        ...
                        break;
                    case 2:
                        128 == (192 & (a = e[i + 1])) && (f = (31 & c) << 6 | 63 & a) > 127 && (u = f);
                        break;
                    case 3:
                        a = e[i + 1], o = e[i + 2], 128 == (192 & a) && 128 == (192 & o) && (f = (15 & c) << 12 | (63 & a) << 6 | 63 & o) > 2047 && (f < 55296 || f > 57343) && (u = f);
                        break;
                    case 4:
                        a = e[i + 1], o = e[i + 2], s = e[i + 3], 128 == (192 & a) && 128 == (192 & o) && 128 == (192 & s) && (f = (15 & c) << 18 | (63 & a) << 12 | (63 & o) << 6 | 63 & s) > 65535 && f < 1114112 && (u = f)
                }
        ...
        t.Buffer = f, t.SlowBuffer = function(e) {
        ...
        }(), t.kMaxLength = o(), f.poolSize = 8192, f._augment = function(e) {
            ...
            for (var a = i - n, o = r - t, s = Math.min(a, o), c = this.slice(n, i), u = e.slice(t, r), h = 0; h < s; ++h)
                if (c[h] !== u[h]) {
                    a = c[h], o = u[h];
                    break
        ...
        function N(e, t, r, n, a) {
            return a || j(e, 0, r, 4), i.write(e, t, r, n, 23, 4), r + 4
        }

        function L(e, t, r, n, a) {
            return a || j(e, 0, r, 8), i.write(e, t, r, n, 52, 8), r + 8
        }
        f.prototype.slice = function(e, t) {
            ...
            return e = +e, t |= 0, r || P(this, e, t, 2, 65535, 0), f.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : B(this, e, t, !0), t + 2
        }, f.prototype.writeUInt16BE = function(e, t, r) {
            return e = +e, t |= 0, r || P(this, e, t, 2, 65535, 0), f.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : B(this, e, t, !1), t + 2
        }, f.prototype.writeUInt32LE = function(e, t, r) {
            return e = +e, t |= 0, r || P(this, e, t, 4, 4294967295, 0), f.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : O(this, e, t, !0), t + 4
        }, f.prototype.writeUInt32BE = function(e, t, r) {
            return e = +e, t |= 0, r || P(this, e, t, 4, 4294967295, 0), f.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : O(this, e, t, !1), t + 4
            ...
            return e = +e, t |= 0, r || P(this, e, t, 2, 32767, -32768), f.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : B(this, e, t, !0), t + 2
        }, f.prototype.writeInt16BE = function(e, t, r) {
            return e = +e, t |= 0, r || P(this, e, t, 2, 32767, -32768), f.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : B(this, e, t, !1), t + 2
        }, f.prototype.writeInt32LE = function(e, t, r) {
            return e = +e, t |= 0, r || P(this, e, t, 4, 2147483647, -2147483648), f.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : O(this, e, t, !0), t + 4
        }, f.prototype.writeInt32BE = function(e, t, r) {
            return e = +e, t |= 0, r || P(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), f.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : O(this, e, t, !1), t + 4
    ...
    var n = t,
        ...
        a = r(5),
        o = r(68);
    n.assert = a, n.toArray = o.toArray, n.zero2 = o.zero2, n.toHex = o.toHex, n.encode = o.encode, n.getNAF = function(e, t) {
        for (var r = [], n = 1 << t + 1, i = e.clone(); i.cmpn(1) >= 0;) {
            var a;
            if (i.isOdd()) {
                var o = i.andln(n - 1);
                a = o > (n >> 1) - 1 ? (n >> 1) - o : o, i.isubn(a)
            } else a = 0;
            r.push(a);
        ...
        for (var n = 0, i = 0; e.cmpn(-n) > 0 || t.cmpn(-i) > 0;) {
            var a, o, s, f = e.andln(3) + n & 3,
                c = t.andln(3) + i & 3;
            3 === f && (f = -1), 3 === c && (c = -1), a = 0 == (1 & f) ? 0 : 3 != (s = e.andln(7) + n & 7) && 5 !== s || 2 !== c ? f : -f, r[0].push(a), o = 0 == (1 & c) ? 0 : 3 != (s = t.andln(7) + i & 7) && 5 !== s || 2 !== f ? c : -c, r[1].push(o), 2 * n === a + 1 && (n = 1 - n), 2 * i === o + 1 && (i = 1 - i), e.iushrn(1), t.iushrn(1)
        }
        return r
    ...
    t.inherits = i, t.toArray = function(e, t) {
        ...
        for (var o = new Array(a / 4), s = 0, f = t; s < o.length; s++, f += 4) {
            var c;
            c = "big" === i ? e[f] << 24 | e[f + 1] << 16 | e[f + 2] << 8 | e[f + 3] : e[f + 3] << 24 | e[f + 2] << 16 | e[f + 1] << 8 | e[f], o[s] = c >>> 0
        }
        return o
        ...
        var f = 0,
            c = t;
        return f += (c = c + n >>> 0) < t ? 1 : 0, f += (c = c + a >>> 0) < a ? 1 : 0, e + r + i + o + (f += (c = c + s >>> 0) < s ? 1 : 0) >>> 0
    }, t.sum64_4_lo = function(e, t, r, n, i, a, o, s) {
        return t + n + a + s >>> 0
    }, t.sum64_5_hi = function(e, t, r, n, i, a, o, s, f, c) {
        var u = 0,
            h = t;
        return u += (h = h + n >>> 0) < t ? 1 : 0, u += (h = h + a >>> 0) < a ? 1 : 0, u += (h = h + s >>> 0) < s ? 1 : 0, e + r + i + o + f + (u += (h = h + c >>> 0) < c ? 1 : 0) >>> 0
    ...
    r(1)(o, i), o.prototype.update = function(e, t, r) {
    ...
    t.d = function() {
        ...
        if ("undefined" != typeof paywallConfig && void 0 !== paywallConfig.cookieDomain && "" !== paywallConfig.cookieDomain) return paywallConfig.cookieDomain;
        return window.location.hostname
    }, t.c = function(e, t) {
        var r = "paywall." + t,
            i = new Event(r);
        n(["Event fired: " + r]), e.dispatchEvent(i)
    };
    var n = function(e) {
        var t, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "info";
        "undefined" != typeof paywallConfig && void 0 !== paywallConfig.debug && paywallConfig.debug && (t = console)[r].apply(t, ["Paywall |"].concat(function(e) {
            if (Array.isArray(e)) {
    ...
    i.prototype.update = function(e, t) {
        ...
        for (var r = this._block, i = this._blockSize, a = e.length, o = this._len, s = 0; s < a;) {
            for (var f = o % i, c = Math.min(a - s, i - f), u = 0; u < c; u++) r[f + u] = e[s + u];
    ...
    var n, i;
    ! function(a) {
        if (void 0 === (i = "function" == typeof(n = a) ? n.call(t, r, t, e) : n) || (e.exports = i), !0, e.exports = a(), !!0) {
            ...
            function n(t, i, a) {
                ...
                if ("undefined" != typeof document) {
                    if (arguments.length > 1) {
                        ...
                        i = r.write ? r.write(i, t) : encodeURIComponent(String(i)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent), t = (t = (t = encodeURIComponent(String(t))).replace(/%(23|24|26|2B|5E|60|7C)/g, decodeURIComponent)).replace(/[\(\)]/g, escape);
                        var f = "";
                        for (var c in a) a[c] && (f += "; " + c, !0 !== a[c] && (f += "=" + a[c]));
                        return document.cookie = t + "=" + i + f
                    }
                    t || (o = {});
    ...
    var n = t;
    n.bignum = r(3), n.define = r(159).define, n.base = r(21), n.constants = r(74), n.decoders = r(164), n.encoders = r(166)
}, function(e, t, r) {
    var n = t;
    n.Reporter = r(161).Reporter, n.DecoderBuffer = r(73).DecoderBuffer, n.EncoderBuffer = r(73).EncoderBuffer, n.Node = r(162)
}, function(e, t, r) {
    "use strict";
    (function(t) {
    ...
    function o(e, t, r, n, i) {
        for (var a, o, s, f, c = r[0], u = r[1], h = r[2], d = r[3], l = e[0] ^ t[0], p = e[1] ^ t[1], b = e[2] ^ t[2], m = e[3] ^ t[3], g = 4, y = 1; y < i; y++) a = c[l >>> 24] ^ u[p >>> 16 & 255] ^ h[b >>> 8 & 255] ^ d[255 & m] ^ t[g++], o = c[p >>> 24] ^ u[b >>> 16 & 255] ^ h[m >>> 8 & 255] ^ d[255 & l] ^ t[g++], s = c[b >>> 24] ^ u[m >>> 16 & 255] ^ h[l >>> 8 & 255] ^ d[255 & p] ^ t[g++], f = c[m >>> 24] ^ u[l >>> 16 & 255] ^ h[p >>> 8 & 255] ^ d[255 & b] ^ t[g++], l = a, p = o, b = s, m = f;
        return a = (n[l >>> 24] << 24 | n[p >>> 16 & 255] << 16 | n[b >>> 8 & 255] << 8 | n[255 & m]) ^ t[g++], o = (n[p >>> 24] << 24 | n[b >>> 16 & 255] << 16 | n[m >>> 8 & 255] << 8 | n[255 & l]) ^ t[g++], s = (n[b >>> 24] << 24 | n[m >>> 16 & 255] << 16 | n[l >>> 8 & 255] << 8 | n[255 & p]) ^ t[g++], f = (n[m >>> 24] << 24 | n[l >>> 16 & 255] << 16 | n[p >>> 8 & 255] << 8 | n[255 & b]) ^ t[g++], [a >>>= 0, o >>>= 0, s >>>= 0, f >>>= 0]
    }
    var s = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
        f = function() {
            ...
            for (var r = [], n = [], i = [
                ...
                i[0][o] = l << 24 | l >>> 8, i[1][o] = l << 16 | l >>> 16, i[2][o] = l << 8 | l >>> 24, i[3][o] = l, l = 16843009 * d ^ 65537 * h ^ 257 * u ^ 16843008 * o, a[0][c] = l << 24 | l >>> 8, a[1][c] = l << 16 | l >>> 16, a[2][c] = l << 8 | l >>> 24, a[3][c] = l, 0 === o ? o = s = 1 : (o = u ^ e[e[e[d ^ u]]], s ^= e[e[s]])
            }
            return {
                SBOX: r,
                INV_SBOX: n,
    ...
    e.exports = f, f.prototype.point = function() {
        ...
        for (var u = this.jpoint(null, null, null), h = this.jpoint(null, null, null), d = i; d > 0; d--) {
            for (f = 0; f < o.length; f++) {
                (c = o[f]) === d ? h = h.mixedAdd(r.points[f]) : c === -d && (h = h.mixedAdd(r.points[f].neg()))
            }
            u = u.add(h)
        }
        return u.toP()
        ...
        var r = 4,
            n = e._getNAFPoints(r);
        r = n.wnd;
        for (var i = n.points, o = a(t, r), f = this.jpoint(null, null, null), c = o.length - 1; c >= 0; c--) {
            for (t = 0; c >= 0 && 0 === o[c]; c--) t++;
            if (c >= 0 && t++, f = f.dblp(t), c < 0) break;
            var u = o[c];
            s(0 !== u), f = "affine" === e.type ? u > 0 ? f.mixedAdd(ia[u - 1 >> 1]) : f.mixedAdd(i[-u - 1 >> 1].neg()) : u > 0 ? f.add(i[u - 1 >> 1]) : f.add(i[-u - 1 >> 1].neg())
        }
        ...
        for (h = n - 1; h >= 1; h -= 2) {
            ...
            } else c[l] = a(r[l], s[l]), c[p] = a(r[p], s[p]), u = Math.max(c[l].length, u), u = Math.max(c[p].length, u)
        }
        ...
        for (h = u; h >= 0; h--) {
            for (var M = 0; h >= 0;) {
                var k = !0;
                for (y = 0; y < n; y++) S[y] = 0 | c[y][h], 0 !== S[y] && (k = !1);
                if (!k) break;
                M++, h--
            }
            ...
            for (y = 0; y < n; y++) {
                var E, A = S[y];
                0 !== A && (A > 0 ? E = f[y][A - 1 >> 1] : A < 0 && (E = f[y][-A - 1 >> 1].neg()), _ = "affine" === E.type ? _.mixedAdd(E) : _.add(E))
            }
        }
    ...
    e.exports = i;
    var n = r(31).EventEmitter;

    function i() {
        n.call(this)
    }
    r(1)(i, n), i.Readable = r(32), i.Writable = r(105), i.Duplex = r(106), i.Transform = r(107), i.PassThrough = r(108), i.Stream = i, i.prototype.pipe = function(e, t) {
        var r = this;
        ...
        function u() {
            r.removeListener("data", i), e.removeListener("drain", a), r.removeListener("end", s), r.removeListener("close", f), r.removeListener("error", c), e.removeListener("error", c), r.removeListener("end", u), r.removeListener("close", u), e.removeListener("close", u)
        }
    ...
    function u(e, t, r, n) {
        ...
        if (void 0 === (a = e._events) ? (a = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== a.newListener && (e.emit("newListener", t, r.listener ? r.listener : r), a = e._events), o = a[t]), void 0 === o) o = a[t] = r, ++e._eventsCount;
            ...
            f.name = "MaxListenersExceededWarning", f.emitter = e, f.type = t, f.count = o.length, s = f, console && console.warn && console.warn(s)
        }
        return e
    }
    ...
    (t = e.exports = r(48)).Stream = t, t.Readable = t, t.Writable = r(33), t.Duplex = r(11), t.Transform = r(51), t.PassThrough = r(104)
}, function(e, t, r) {
    "use strict";
    (function(t, n, i) {
        var a = r(22);
        ...
        function y(e) {
            if (s = s || r(11), !(p.call(y, this) || this instanceof s)) return new y(e);
        ...
        function _(e, t) {
            ...
            if (e._writev && r && r.next) {
                ...
                i.allBuffers = f, v(e, t, !0, t.length, i, "", a.finish), t.pendingcb++, t.lastBufferedRequest = null, a.next ? (t.corkedRequestsFree = a.next, a.next = null) : t.corkedRequestsFree = new o(t), t.bufferedRequestCount = 0
            } else {
                for (; r;) {
                    var c = r.chunk,
                        u = r.encoding,
        ...
        function k(e, t) {
            ...
            return r && (! function(e, t) {
                t.prefinished || t.finalCalled || ("function" == typeof e._final ? (t.pendingcb++, t.finalCalled = !0, a.nextTick(M, e, t)) : (t.prefinished = !0, e.emit("prefinish")))
    ...
    }).call(t, r(9), r(85).setImmediate, r(7))
}, function(e, t, r) {
    "use strict";
    var n = r(2).Buffer,
    ...
    i(l, a), l.prototype._update = function() {
        for (var e = o, t = 0; t < 16; ++t) e[t] = this._block.readInt32LE(4 * t);
        for (var r = 0 | this._a, n = 0 | this._b, i = 0 | this._c, a = 0 | this._d, l = 0 | this._e, w = 0 | this._a, _ = 0 | this._b, S = 0 | this._c, M = 0 | this._d, k = 0 | this._e, E = 0; E < 80; E += 1) {
            var A, x;
            E < 16 ? (A = b(r, n, i, a, l, e[s[E]], h[0], c[E]), x = v(w, _, S, M, k, e[f[E]], d[0], u[E])) : E < 32 ? (A = m(r, n, i, a, l, e[s[E]], h[1], c[E]), x = y(w, _, S, M, k, e[f[E]], d[1], u[E])) : E < 48 ? (A = g(r, n, i, a, l, e[s[E]], h[2], c[E]), x = g(w, _, S, M, k, e[f[E]], d[2], u[E])) : E < 64 ? (A = y(r, n, i, a, l, e[s[E]], h[3], c[E]), x = m(w, _, S, M, k, e[f[E]], d[3], u[E])) : (A = v(r, n, i, a, l, e[s[E]], h[4], c[E]), x = b(w, _, S, M, k, e[f[E]], d[4], u[E])), r = l, l = a, a = p(i, 10), i = n, n = A, w = k, k = M, M = p(S, 10), S = _, _ = x
        }
        var I = this._b + i + M | 0;
        this._b = this._c + a + k | 0, this._c = this._d + l + w | 0, this._d = this._e + r + _ | 0, this._e = this._a + n + S | 0, this._a = I
    ...
    (t = e.exports = function(e) {
        ...
        return new r
    }).sha = r(109), t.sha1 = r(110), t.sha224 = r(111), t.sha256 = r(52), t.sha384 = r(112), t.sha512 = r(53)
}, function(e, t, r) {
    "use strict";
    ...
    (function(t) {
        ...
        function a(e, r) {
            ...
            return b.imul(d), p.iadd(b), new t(p.imul(i.unblinder).umod(r.modulus).toArray(!1, a))
        }
    ...
    "use strict";
    var n = t;
    n.version = r(140).version, n.utils = r(6), n.rand = r(40), n.curve = r(69), n.curves = r(43), n.ec = r(151), n.eddsa = r(155)
}, function(e, t, r) {
    "use strict";
    var n, i = t,
        a = r(44),
    ...
    var n = t;
    n.utils = r(8), n.common = r(19), n.sha = r(144), n.ripemd = r(148), n.hmac = r(149), n.sha1 = n.sha.sha1, n.sha256 = n.sha.sha256, n.sha224 = n.sha.sha224, n.sha384 = n.sha.sha384, n.sha512 = n.sha.sha512, n.ripemd160 = n.ripemd.ripemd160
}, function(e, t, r) {
    "use strict";
    ...
    var d = {
        ...
        l = function() {
            function e() {
                ...
                }(this, e), this.config = t, void 0 === t.element ? (document.body.classList.contains("paywall") || document.body.classList.add("paywall"), this.element = document.querySelector(".paywall")) : this.element = t.element, this.cookie = "paywall_user", this.version = "1.0.0", this.subscriptionData = "subscription_data_v" + this.version
            }
            return s(e, [{
                key: "user",
                value: function() {
                    var e = c.get(this.cookie);
                    if (e) try {
                        return u.decode(e, Object(a.a)())
                    } catch (e) {
                        this.logout()
                    }
                    return !1
                    ...
                    var e = f(i.a.mark(function e() {
                        ...
                        return i.a.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (!0 !== this.user().checkSubscription || this.user().dontCheckSubscription) {
                                        e.next = 7;
                                        break
                                    }
                                    return localStorage.removeItem(this.subscriptionData), e.next = 4, this.getSubscriptionData().then(function(e) {
                                        return Object(a.d)("User is subscribed:", t.user() && e.is_active), t.user() && e.is_active
                                    }).catch(function(e) {
                                        return t.user() && t.user().subscribed
                                    });
                                case 4:
                                    return e.abrupt("return", e.sent);
                                case 7:
                                    return e.abrupt("return", this.user() && this.user().subscribed);
                                case 8:
                                case "end":
                                    return e.stop()
                            }
                ...
                key: "login",
                value: function(e) {
                    c.set(this.cookie, u.encode(e, Object(a.a)()), {
                        domain: Object(a.a)(),
                        expires: 30
                    })
                }
                ...
                value: function(e) {
                    var t = new h(e, d);
                    return !t.fails() || (Object(a.b)("User object no válido: ", t.errors.all(), e), !1)
                }
            }, {
                key: "isDev",
                value: function() {
                    return void 0 !== this.user().roles && this.user().roles.indexOf("dev") >= 0
                }
            }, {
                key: "addSubscribed",
                value: function(e) {
                    var t = this.user();
                    t.subscribed = e, t.checkSubscription = !1, c.set(this.cookie, u.encode(t, Object(a.a)()), {
                        domain: Object(a.a)(),
                        expires: 1
                    })
                }
                ...
                value: function() {
                    var e = f(i.a.mark(function e() {
                        ...
                        return i.a.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (t = {}, null === localStorage.getItem(this.subscriptionData) || void 0 === localStorage.getItem(this.subscriptionData) || "undefined" === localStorage.getItem(this.subscriptionData)) {
                                        e.next = 6;
                                        break
                                    }
                                    if (!(t = JSON.parse(localStorage.getItem(this.subscriptionData)))) {
                                        e.next = 6;
                                        break
                                    }
                                    if (!(null !== t.expiration && t.expiration > (new Date).getTime() - 36e5)) {
                                        e.next = 6;
                                        break
                                    }
                                    return e.abrupt("return", t);
                                case 6:
                                    return e.next = 8, fetch(this.config.paywallUrl + "/subscription-data", {
                                        credentials: "include",
                                        mode: "cors"
                                    }).then(function(e) {
                                        return e.json()
                                        ...
                                        })).is_active && null !== t.is_active ? (localStorage.setItem(r.subscriptionData, JSON.stringify(t)), r.addSubscribed(t.is_active)) : r.addSubscribed(!1), t
                                    }).catch(function(e) {
                                        console.log(e), t = {
                                            expiration: (new Date).getTime()
                                        }, localStorage.setItem(r.subscriptionData, JSON.stringify(t))
                                    });
                                case 8:
    ...
    r(1)(a, i), a.prototype._transform = function(e, t, r) {
        var n = null;
        try {
            this.update(e, t)
        } catch (e) {
    ...
    (function(t, n) {
        ...
        function v(e) {
            if (a = a || r(11), !(this instanceof v)) return new v(e);
        ...
        function w(e, t, r, n, i) {
            ...
            null === t ? (o.reading = !1, function(e, t) {
                ...
                var n;
                return r
            }(o, t)), a ? e.emit("error", a) : o.objectMode || t && t.length > 0 ? ("string" == typeof t || o.objectMode || Object.getPrototypeOf(t) === c.prototype || (t = function(e) {
                return c.from(e)
            }(t)), n ? o.endEmitted ? e.emit("error", new Error("stream.unshift() after end event")) : _(e, o, t, !0) : o.ended ? e.emit("error", new Error("stream.push() after EOF")) : (o.reading = !1, o.decoder && !r ? (t = o.decoder.write(t), o.objectMode || 0 !== t.length ? _(e, o, t, !1) : A(e, o)) : _(e, o, t, !1))) : n || (o.reading = !1));
            return function(e) {
        ...
        function _(e, t, r, n) {
            t.flowing && 0 === t.length && !t.sync ? (e.emit("data", r), e.read(0)) : (t.length += t.objectMode ? 1 : r.length, n ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && k(e)), A(e, t)
        }
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = r(34).StringDecoder), this._readableState.decoder = new p(e), this._readableState.encoding = e, this
        };
        var S = 8388608;
        ...
        v.prototype.read = function(e) {
            ...
            var t = this._readableState,
                r = e;
            if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended)) return l("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? P(this) : k(this), null;
            if (0 === (e = M(e, t)) && t.ended) return 0 === t.length && P(this), null;
            ...
            function b(t) {
                l("ondata"), p = !1, !1 !== e.write(t) || p || ((1 === a.pipesCount && a.pipes === e || a.pipesCount > 1 && -1 !== O(a.pipes, e)) && !d && (l("false write response, pause", r._readableState.awaitDrain), r._readableState.awaitDrain++, p = !0), r.pause())
            }
            ...
            return r.on("data", b),
                ...
                }(e, "error", m), e.once("close", g), e.once("finish", y), e.emit("pipe", r), a.flowing || (l("pipe resume"), r.resume()), e
            ...
            if ("data" === e) !1 !== this._readableState.flowing && this.resume();
                ...
                n.endEmitted || n.readableListening || (n.readableListening = n.needReadable = !0, n.emittedReadable = !1, n.reading ? n.length && k(this) : i.nextTick(I, this))
            }
            return r
    ...
    i.inherits = r(1), i.inherits(a, n), a.prototype.push = function(e, t) {
    ...
    n(f, i), f.prototype.init = function() {
        ...
        for (var t, r = this._w, n = 0 | this._a, i = 0 | this._b, a = 0 | this._c, s = 0 | this._d, f = 0 | this._e, p = 0 | this._f, b = 0 | this._g, m = 0 | this._h, g = 0; g < 16; ++g) r[g] = e.readInt32BE(4 * g);
        for (; g < 64; ++g) r[g] = 0 | (((t = r[g - 2]) >>> 17 | t << 15) ^ (t >>> 19 | t << 13) ^ t >>> 10) + r[g - 7] + l(r[g - 15]) + r[g - 16];
        for (var y = 0; y < 64; ++y) {
            var v = m + d(f) + c(f, p, b) + o[y] + r[y] | 0,
                w = h(n) + u(n, i, a) | 0;
            m = b, b = p, p = f, f = s + v | 0, s = a, a = i, i = n, n = v + w | 0
        }
    ...
    n(f, i), f.prototype.init = function() {
        ...
        for (var t = this._w, r = 0 | this._ah, n = 0 | this._bh, i = 0 | this._ch, a = 0 | this._dh, s = 0 | this._eh, f = 0 | this._fh, y = 0 | this._gh, v = 0 | this._hh, w = 0 | this._al, _ = 0 | this._bl, S = 0 | this._cl, M = 0 | this._dl, k = 0 | this._el, E = 0 | this._fl, A = 0 | this._gl, x = 0 | this._hl, I = 0; I < 32; I += 2) t[I] = e.readInt32BE(4 * I), t[I + 1] = e.readInt32BE(4 * I + 4);
        for (; I < 160; I += 2) {
            var R = t[I - 30],
                T = t[I - 30 + 1],
                C = l(R, T),
                P = p(T, R),
                B = b(R = t[I - 4], T = t[I - 4 + 1]),
                O = m(T, R),
                j = t[I - 14],
                N = t[I - 14 + 1],
                L = t[I - 32],
                ...
                q = P + N | 0,
                z = C + j + g(q, P) | 0;
            z = (z = z + B + g(q = q + O | 0, O) | 0) + L + g(q = q + D | 0, D) | 0, t[I] = z, t[I + 1] = q
        }
        for (var U = 0; U < 160; U += 2) {
            ...
            var F = u(r, n, i),
                ...
                Q = x + Y | 0,
                $ = v + V + g(Q, x) | 0;
            $ = ($ = ($ = $ + G + g(Q = Q + Z | 0, Z) | 0) + X + g(Q = Q + J | 0, J) | 0) + z + g(Q = Q + q | 0, q) | 0;
            var ee = W + H | 0,
                te = K + F + g(ee, W) | 0;
            v = y, x = A, y = f, A = E, f = s, E = k, s = a + $ + g(k = M + Q | 0, M) | 0, a = i, M = S, i = n, S = _, n = r, _ = w, r = $ + te + g(w = Q + ee | 0, Q) | 0
        }
        this._al = this._al + w | 0, this._bl = this._bl + _ | 0, this._cl = this._cl + S | 0, this._dl = this._dl + M | 0, this._el = this._el + k | 0, this._fl = this._fl + E | 0, this._gl = this._gl + A | 0, this._hl = this._hl + x | 0, this._ah = this._ah + r + g(this._al, w) | 0, this._bh = this._bh + n + g(this._bl, _) | 0, this._ch = this._ch + i + g(this._cl, S) | 0, this._dh = this._dh + a + g(this._dl, M) | 0, this._eh = this._eh + s + g(this._el, k) | 0, this._fh = this._fh + f + g(this._fl, E) | 0, this._gh = this._gh + y + g(this._gl, A) | 0, this._hh = this._hh + v + g(this._hl, x) | 0
    }, f.prototype._hash = function() {
    ...
    function h(e, t) {
        ...
        (this._alg = e, this._key = t, t.length > r) ? t = ("rmd160" === e ? new f : c(e)).update(t).digest(): t.length < r && (t = o.concat([t, u], r));
    ...
    t.pbkdf2 = r(115), t.pbkdf2Sync = r(60)
}, function(e, t, r) {
    (function(t) {
    ...
    function h(e, t, r) {
        ...
        h.copy(p, 0, 0, s), this.ipad1 = p, this.ipad2 = h, this.opad = d, this.alg = e, this.blocksize = s, this.hash = o, this.size = u[e]
    }
    h.prototype.run = function(e, t) {
        ...
        o(e, t, r, n), f.isBuffer(e) || (e = f.from(e, s)), f.isBuffer(t) || (t = f.from(t, s));
        ...
        for (var l = 0, p = u[i], b = Math.ceil(n / p), m = 1; m <= b; m++) {
            ...
            for (var g = a.run(d, a.ipad1), y = g, v = 1; v < r; v++) {
                y = a.run(y, a.ipad2);
    ...
    o(u, a), u.prototype._update = function(e) {
    ...
    r(1)(o, a), o.prototype._update = function(e) {
    ...
    "use strict";
    var n = t;
    n.base = r(25), n.short = r(141), n.mont = r(142), n.edwards = r(143)
}, function(e, t, r) {
    "use strict";
    var n = r(8).rotr32;
    ...
    n.inherits(y, m), e.exports = y, y.blockSize = 512, y.outSize = 256, y.hmacStrength = 192, y.padLength = 64, y.prototype._update = function(e, t) {
        ...
        for (o(this.k.length === r.length), n = 0; n < r.length; n++) {
            var S = c(_, l(y), u(y, v, w), this.k[n], r[n]),
                M = s(d(i), h(i, a, m));
            _ = w, w = v, v = y, y = s(g, S), g = m, m = a, a = i, i = s(S, M)
        }
        this.h[0] = s(this.h[0], i), this.h[1] = s(this.h[1], a), this.h[2] = s(this.h[2], m), this.h[3] = s(this.h[3], g), this.h[4] = s(this.h[4], y), this.h[5] = s(this.h[5], v), this.h[6] = s(this.h[6], w), this.h[7] = s(this.h[7], _)
    ...
    n.inherits(v, g), e.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(e, t) {
        ...
        for (var B = 0; B < r.length; B += 2) {
            var O = C,
                ...
                F = r[B],
                H = r[B + 1],
                K = b(O, j, N, L, D, q, z, U, F, H),
                W = m(O, j, N, L, D, q, z, U, F, H);
            O = k(n, i), j = E(n, i), N = S(n, i, o, s, f), L = M(n, i, o, s, f, c);
            var V = h(O, j, N, L),
                Y = d(O, j, N, L);
            C = R, P = T, R = v, T = I, v = g, I = y, g = h(l, p, K, W), y = d(p, p, K, W), l = f, p = c, f = o, c = s, o = n, s = i, n = h(K, W, V, Y), i = d(K, W, V, Y)
        }
        u(this.h, 0, n, i), u(this.h, 2, o, s), u(this.h, 4, f, c), u(this.h, 6, l, p), u(this.h, 8, g, y), u(this.h, 10, v, I), u(this.h, 12, R, T), u(this.h, 14, C, P)
    ...
    n(o, i), t.DecoderBuffer = o, o.prototype.save = function() {
        return {
            offset: this.offset,
    ...
    e.exports = f, f.prototype.decode = function(e, t) {
    ...
    }, n(c, a.Node), c.prototype._peekTag = function(e, t, r) {
        ...
        if ("gentime" === t) var n = 0 | r.slice(0, 4),
            ...
            n = 0 | r.slice(0, 2), i = 0 | r.slice(2, 4), a = 0 | r.slice(4, 6), o = 0 | r.slice(6, 8), s = 0 | r.slice(8, 10), f = 0 | r.slice(10, 12);
            n = n < 70 ? 2e3 + n : 1900 + n
        }
    ...
    e.exports = f, f.prototype.encode = function(e, t) {
    ...
    }, n(c, o.Node), c.prototype._encodeComposite = function(e, t, r, n) {
        ...
        if (n.length < 128) return (a = new i(2))[0] = o, a[1] = n.length, this._createEncoderBuffer([a, n]);
    ...
    e.exports = {
        replacements: {
            between: function(e, t) {
                ...
                return this._replacePlaceholders(t, e, {
                    min: r[0],
                    max: r[1]
                })
            },
            required_if: function(e, t) {
                var r = t.getParameters();
                return this._replacePlaceholders(t, e, {
                    other: this._getAttributeName(r[0]),
                    value: r[1]
                })
            },
            ...
            required_with: function(e, t) {
                var r = t.getParameters();
                return this._replacePlaceholders(t, e, {
                    field: this._getAttributeName(r[0])
                })
            },
            required_with_all: function(e, t) {
                var r = t.getParameters(),
                    n = this._getAttributeName.bind(this);
                return this._replacePlaceholders(t, e, {
                    fields: r.map(n).join(", ")
                })
            },
            ...
            after: function(e, t) {
                var r = t.getParameters();
                return this._replacePlaceholders(t, e, {
                    after: this._getAttributeName(r[0])
                })
            },
            before: function(e, t) {
                var r = t.getParameters();
                return this._replacePlaceholders(t, e, {
                    before: this._getAttributeName(r[0])
                })
            },
            after_or_equal: function(e, t) {
                var r = t.getParameters();
                return this._replacePlaceholders(t, e, {
                    after_or_equal: this._getAttributeName(r[0])
                })
            },
            before_or_equal: function(e, t) {
                var r = t.getParameters();
                return this._replacePlaceholders(t, e, {
                    before_or_equal: this._getAttributeName(r[0])
                })
            },
            same: function(e, t) {
                var r = t.getParameters();
                return this._replacePlaceholders(t, e, {
                    same: this._getAttributeName(r[0])
                })
            }
        },
    ...
    e.exports = {
        isDetected: function() {
            ...
            if (t.setAttribute("class", "pub_300x250 pub_300x250m pub_728x90 text-ad textAd text_ad text_ads text-ads text-ad-links"), t.setAttribute("style", "width: 1px ! important; height: 1px !important; position: absolute !important; left: -10000px !important; top: -1000px !important;"), window.document.body.appendChild(t), null !== window.document.body.getAttribute("abp") || null === t.offsetParent || 0 == t.offsetHeight || 0 == t.offsetLeft || 0 == t.offsetTop || 0 == t.offsetWidth || 0 == t.clientHeight || 0 == t.clientWidth) e = !0;
            else if (void 0 !== window.getComputedStyle) {
                var r = window.getComputedStyle(t, null);
                !r || "none" != r.getPropertyValue("display") && "hidden" != r.getPropertyValue("visibility") || (e = !0)
            }
    ...
    "use strict";
    var n = r(186),
        i = "undefined" != typeof window && (window.RequestFileSystem || window.webkitRequestFileSystem);
    e.exports = function() {
        return new Promise((e, t) => {
            n() ? (i || t(-1), i(window.TEMPORARY, 100, () => e(0), () => t(1))) : t(-2)
        })
    }
}, function(e, t, r) {
    (function(e) {
        ...
        }, r(86), t.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== e && e.setImmediate || this && this.setImmediate, t.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== e && e.clearImmediate || this && this.clearImmediate
    }).call(t, r(7))
}, function(e, t, r) {
    (function(e, t) {
        ! function(e, r) {
    ...
    var i = r(15),
        a = function() {
            function e() {
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this.key = "url_metered", this.maximumDays = 10
            }
            return n(e, [{
                key: "setUrl",
                value: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new URL(window.location.href).pathname,
                        t = this.getUrls();
                    if (void 0 === t.find(function(t) {
                            return t.u === e
                        })) {
                        t.push({
                            u: e,
                        ...
                        return localStorage.setItem(this.key, r), !0
                    }
                    return !1
                }
            }, {
                ...
                value: function() {
                    var e = this,
                        t = [];
                    return null !== localStorage.getItem(this.key) ? t = JSON.parse(localStorage.getItem(this.key)) : void 0 !== i.get(this.key) && (t = JSON.parse(i.get(this.key))), t.filter(function(t) {
                        var r = new Date;
                        return r.setDate(r.getDate() - e.maximumDays), new Date(t.t).getTime() >= r.getTime()
                    })
                }
            }, {
                key: "getLastUrl",
                value: function() {
                    var e = this.getUrls();
                    return e.length ? e[e.length - 1].u : null
                }
            }]), e
        }();
    t.a = a
    ...
    if (n.regeneratorRuntime = void 0, e.exports = r(90), i) n.regeneratorRuntime = a;
    else try {
    ...
    ! function(t) {
        ...
        if (u) c && (e.exports = u);
            ...
            var g = Object.getPrototypeOf,
                y = g && g(g(C([])));
            y && y !== n && i.call(y, o) && (m = y);
            var v = k.prototype = S.prototype = Object.create(m);
            M.prototype = v.constructor = k, k.constructor = M, k[f] = M.displayName = "GeneratorFunction", u.isGeneratorFunction = function(e) {
                var t = "function" == typeof e && e.constructor;
                return !!t && (t === M || "GeneratorFunction" === (t.displayName || t.name))
            }, u.mark = function(e) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(e, k) : (e.__proto__ = k, f in e || (e[f] = "GeneratorFunction")), e.prototype = Object.create(v), e
            }, u.awrap = function(e) {
                return {
                    __await: e
                }
            ...
            }, u.values = C, T.prototype = {
                constructor: T,
                reset: function(e) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = r, this.done = !1, this.delegate = null, this.method = "next", this.arg = r, this.tryEntries.forEach(R), !e)
        ...
        function x(e, t) {
            ...
            if (n === r) {
                if (t.delegate = null, "throw" === t.method) {
                    if (e.iterator.return && (t.method = "return", t.arg = r, x(e, t), "throw" === t.method)) return b;
    ...
    t.iframeResizer = r(93), t.iframeResizerContentWindow = r(94)
}, function(e, t, r) {
    var n, i, a;
    ! function(r) {
        if ("undefined" != typeof window) {
            var o, s = 0,
                ...
                v = {};
            window.jQuery && ((o = window.jQuery).fn ? o.fn.iFrameResize || (o.fn.iFrameResize = function(e) {
                return this.filter("iframe").each(function(t, r) {
                    U(r, e)
                }).end()
            }) : A("", "Unable to bind to jQuery, it is not fully loaded.")), i = [], (a = "function" == typeof(n = V) ? n.apply(t, i) : n) === r || (e.exports = a), window.iFrameResize = window.iFrameResize || V()
        }
        ...
        function I(e, t, r, n) {
            !0 === n && "object" == typeof window.console && console[e](M(t), r)
        }

        function R(e) {
            function t() {
                r("Height"), r("Width"), D(function() {
                    L(y), O(w), f("onResized", y)
                }, y, "init")
            }

            function r(e) {
                var t = Number(m[w]["max" + e]),
                    r = Number(m[w]["min" + e]),
                    n = e.toLowerCase(),
                    i = Number(y[n]);
                E(w, "Checking " + n + " is in range " + r + "-" + t), i < r && (i = r, E(w, "Set " + n + " to min value")), i > t && (i = t, E(w, "Set " + n + " to max value")), y[n] = "" + i
            }

            function n(e) {
                return g.substr(g.indexOf(":") + u + e)
            }
            ...
            function i(e, t) {
                ...
                r = function() {
                    var r, n;
                    q("Send Page Info", "pageInfo:" + (r = document.body.getBoundingClientRect(), n = y.iframe.getBoundingClientRect(), JSON.stringify({
                        iframeHeight: n.height,
                        iframeWidth: n.width,
                        clientHeight: Math.max(document.documentElement.clientHeight, window.innerHeight || 0),
                        clientWidth: Math.max(document.documentElement.clientWidth, window.innerWidth || 0),
                        offsetTop: parseInt(n.top - r.top, 10),
                        offsetLeft: parseInt(n.left - r.left, 10),
                ...
                }, n = 32, v[i = t] || (v[i] = setTimeout(function() {
                    v[i] = null, r()
                }, n))
            }
            ...
            function o(e) {
                var t = e ? a(y.iframe) : {
                    ...
                    r = {
                        x: Number(y.width) + t.x,
                        y: Number(y.height) + t.y
                    };
                E(w, "Reposition requested from iFrame (offset x:" + t.x + " y:" + t.y + ")"), window.top !== window.self ? window.parentIFrame ? window.parentIFrame["scrollTo" + (e ? "Offset" : "")](r.x, r.y) : x(w, "Unable to scroll to requested position, window.parentIFrame not found") : (l = r, s(), E(w, "--"))
            }

            function s() {
                !1 !== f("onScroll", l) ? O(w) : j()
            }
            ...
            "[iFrameResizerChild]Ready" === g ? function() {
                for (var e in m) q("iFrame requested init", z(e), document.getElementById(e), e)
            }() : h === ("" + g).substr(0, d) && g.substr(d).split(":")[0] in m ? (b = g.substr(d).split(":"), y = {
                iframe: m[b[0]] && m[b[0]].iframe,
                id: b[0],
                height: b[1],
                width: b[2],
                type: b[3]
                ...
                false: 1,
                undefined: 1
            }) && E(w, "Ignoring init message from meta parent page"), !p && function(e) {
                var t = !0;
                return m[e] || (t = !1, x(y.type + " No settings for " + e + ". Message was: " + g)), t
            }(w) && (E(w, "Received: " + g), c = !0, null === y.iframe && (x(w, "IFrame (" + y.id + ") not found"), c = !1), c && function() {
                var t, r = e.origin,
                    n = m[w] && m[w].checkOrigin;
                if (n && "" + r != "null" && !(n.constructor === Array ? function() {
                        var e = 0,
                            t = !1;
                        for (E(w, "Checking connection is from allowed list of origins: " + n); e < n.length; e++)
                            if (n[e] === r) {
                                t = !0;
                                break
                            } return t
                    }() : (t = m[w] && m[w].remoteHost, E(w, "Checking connection is from: " + t), r === t))) throw new Error("Unexpected message received from: " + r + " for " + y.iframe.id + ". Message was: " + e.data + ". This error can be disabled by setting the checkOrigin: false option or by providing of array of trusted domains.");
                return !0
            }() && function() {
                switch (m[w] && m[w].firstRun && m[w] && (m[w].firstRun = !1), y.type) {
                    case "close":
                        m[w].closeRequeston ? T(w, "onCloseRequest", m[w].iframe) : P(y.iframe);
                        break;
                    case "message":
                        d = n(6), E(w, "onMessage passed: {iframe: " + y.iframe.id + ", message: " + d + "}"), f("onMessage", {
                            iframe: y.iframe,
                    ...
                    case "pageInfo":
                        i(m[w] && m[w].iframe, w),
                            function() {
                                function e(e, n) {
                                    function a() {
                                        m[r] ? i(m[r].iframe, r) : t()
                                    } ["scroll", "resize"].forEach(function(t) {
                                        E(r, e + t + " listener for sendPageInfo"), n(window, t, a)
                                    })
                                }
                                ...
                                var r = w;
                                e("Add ", _), m[r] && (m[r].stopPageInfo = t)
                            }();
                        break;
                    case "pageInfoStop":
                        ...
                        break;
                    case "inPageLink":
                        e = n(9), c = e.split("#")[1] || "", u = decodeURIComponent(c), (h = document.getElementById(u) || document.getElementsByName(u)[0]) ? (r = a(h), E(w, "Moving to in page link (#" + c + ") at x: " + r.x + " y: " + r.y), l = {
                            x: r.x,
                            y: r.y
                        }, s(), E(w, "--")) : window.top !== window.self ? window.parentIFrame ? window.parentIFrame.moveToAnchor(c) : E(w, "In page link #" + c + " not found and window.parentIFrame not found") : E(w, "In page link #" + c + " not found");
                        break;
                    case "reset":
                        N(y);
                        break;
        ...
        function T(e, t, r) {
            var n = null,
                i = null;
            if (m[e]) {
                if ("function" != typeof(n = m[e][t])) throw new TypeError(t + " on iFrame[" + e + "] is not a function");
                i = n(r)
            }
            return i
        }
        ...
        function P(e) {
            ...
            T(t, "onClosed", t), E(t, "--"), C(e)
        }

        function B(e) {
            null === l && E(e, "Get page position: " + (l = {
        ...
        function O(e) {
            null !== l && (window.scrollTo(l.x, l.y), E(e, "Set page position: " + l.x + "," + l.y), j())
        }
        ...
        function N(e) {
            E(e.id, "Size reset requested by " + ("init" === e.type ? "host page" : "iFrame")), B(e.id), D(function() {
                L(e), q("reset", "reset", e.iframe, e.id)
            }, e, "reset")
        }

        function L(e) {
            function t(t) {
                c || "0" !== e[t] || (c = !0, E(n, "Hidden iFrame detected, creating visibility listener"), function() {
                    function e() {
                        Object.keys(m).forEach(function(e) {
                            ! function(e) {
                                ...
                                m[e] && (r = m[e].iframe, null !== r.offsetParent) && (t("height") || t("width")) && q("Visibility change", "resize", m[e].iframe, e);
                                var r
                            }(m[e])
                        })
                    }
                    ...
                    function t(t) {
                        E("window", "Mutation observed: " + t[0].target + " " + t[0].type), F(e, 16)
                    }
                    var r = w();
                    r && (n = document.querySelector("body"), new r(t).observe(n, {
                        attributes: !0,
                        attributeOldValue: !1,
                        characterData: !0,
            ...
            function r(r) {
                ! function(t) {
                    e.id ? (e.iframe.style[t] = e[t] + "px", E(e.id, "IFrame (" + n + ") " + t + " set to " + e[t] + "px")) : E("undefined", "messageData id not set")
                }(r), t(r)
            }
            var n = e.iframe.id;
            m[n] && (m[n].sizeHeight && r("height"), m[n].sizeWidth && r("width"))
        }

        function D(e, t, r) {
            r !== t.type && p ? (E(t.id, "Requesting animation frame"), p(e)) : e()
        }

        function q(e, t, r, n, i) {
            var a, o = !1;
            n = n || r.id, m[n] && (r && "contentWindow" in r && null !== r.contentWindow ? (a = m[n] && m[n].targetOrigin, E(n, "[" + e + "] Sending msg to iframe[" + n + "] (" + t + ") targetOrigin: " + a), r.contentWindow.postMessage(h + t, a)) : x(n, "[" + e + "] IFrame(" + n + ") not found"), i && m[n] && m[n].warningTimeout && (m[n].msgTimeout = setTimeout(function() {
                !m[n] || m[n].loaded || o || (o = !0, x(n, "IFrame has not responded within " + m[n].warningTimeout / 1e3 + " seconds. Check iFrameResizer.contentWindow.js has been loaded in iFrame. This message can be ignored if everything is working, or you can set the warningTimeout option to a higher value or zero to suppress this warning."))
            }, m[n].warningTimeout)))
        }
        ...
        function U(e, t) {
            function n(e) {
                ...
                if (2 === t.length) {
                    var r = "on" + t[0].charAt(0).toUpperCase() + t[0].slice(1);
                    this[r] = this[e], delete this[e], x(o, "Deprecated: '" + e + "' has been renamed '" + r + "'. The old method will be removed in the next major version.")
                }
            }
            var i, a, o = function(r) {
                var n;
                return "" === r && (e.id = (n = t && t.id || y.id + s++, null !== document.getElementById(n) && (n += s++), r = n), f = (t || {}).log, E(r, "Added missing iframe ID: " + r + " (" + e.src + ")")), r
            }(e.id);
            o in m && "iFrameResizer" in e ? x(o, "Ignored iFrame, already setup.") : (! function(t) {
                var r;
                t = t || {}, m[o] = {
                        firstRun: !0,
                        iframe: e,
                    ...
                    function(e) {
                        for (var t in y) Object.prototype.hasOwnProperty.call(y, t) && (m[o][t] = Object.prototype.hasOwnProperty.call(e, t) ? e[t] : y[t])
                    }(t), m[o] && (m[o].targetOrigin = !0 === m[o].checkOrigin ? "" === (r = m[o].remoteHost) || "file://" === r ? "*" : r : "*")
            }(t), function() {
                switch (E(o, "IFrame scrolling " + (m[o] && m[o].scrolling ? "enabled" : "disabled") + " for " + o), e.style.overflow = !1 === (m[o] && m[o].scrolling) ? "hidden" : "auto", m[o] && m[o].scrolling) {
                    case "omit":
                        break;
                    case !0:
                        e.scrolling = "yes";
                    ...
                    case !1:
                        ...
                        break;
                    default:
                        e.scrolling = m[o] ? m[o].scrolling : "no"
                }
            }(), function() {
                function t(t) {
                    1 / 0 !== m[o][t] && 0 !== m[o][t] && (e.style[t] = m[o][t] + "px", E(o, "Set " + t + " = " + m[o][t] + "px"))
                }

                function r(e) {
                    if (m[o]["min" + e] > m[o]["max" + e]) throw new Error("Value for min" + e + " can not be greater than max" + e)
                }
                r("Height"), r("Width"), t("maxHeight"), t("minHeight"), t("maxWidth"), t("minWidth")
            }(), "number" != typeof(m[o] && m[o].bodyMargin) && "0" !== (m[o] && m[o].bodyMargin) || (m[o].bodyMarginV1 = m[o].bodyMargin, m[o].bodyMargin = m[o].bodyMargin + "px"), i = z(o), (a = w()) && function(t) {
                ...
                var t, n;
                q("iFrame.onload", i, e, r, !0), t = m[o] && m[o].firstRun, n = m[o] && m[o].heightCalculationMethod in b, !t && n && N({
                    iframe: e,
                    height: 0,
                    width: 0,
                    type: "init"
                })
            }), q("init", i, e, r, !0), m[o] && (m[o].iframe.iFrameResizer = {
                close: P.bind(null, m[o].iframe),
                removeListeners: C.bind(null, m[o].iframe),
                resize: q.bind(null, "Window resize", "resize", m[o].iframe),
                moveToAnchor: function(e) {
                    q("Move to anchor", "moveToAnchor:" + e, m[o].iframe, o)
                },
                sendMessage: function(e) {
                    q("Send Message", "message:" + (e = JSON.stringify(e)), m[o].iframe, o)
                }
            }))
        }
        ...
        function H() {
            "hidden" !== document.visibilityState && (E("document", "Trigger event: Visiblity change"), F(function() {
        ...
        function K(e, t) {
            Object.keys(m).forEach(function(r) {
                ...
                })(r) && q(e, t, document.getElementById(r), r)
            })
        }

        function W() {
            _(window, "message", R), _(window, "resize", function() {
                var e;
                E("window", "Trigger event: " + (e = "resize")), F(function() {
                    K("Window " + e, "resize")
                }, 16)
            }), _(document, "visibilitychange", H), _(document, "-webkit-visibilitychange", H)
        }

        function V() {
            function e(e, r) {
                r && (! function() {
                    if (!r.tagName) throw new TypeError("Object is not a valid DOM element");
                    if ("IFRAME" !== r.tagName.toUpperCase()) throw new TypeError("Expected <IFRAME> tag, found <" + r.tagName + ">")
                }(), U(r, e), t.push(r))
            }
            var t;
            return function() {
                    ...
                    p || E("setup", "RequestAnimationFrame not supported")
                }(), W(),
                function(n, i) {
                    switch (t = [], function(e) {
    ...
    ! function(t) {
        if ("undefined" != typeof window) {
            var r = !0,
                ...
                U = {
                    height: function() {
                        return fe("Custom height calculation function not defined"), document.documentElement.offsetHeight
                    },
                    width: function() {
                        return fe("Custom width calculation function not defined"), document.body.scrollWidth
                    }
                },
                F = {},
                H = !1;
            try {
                ...
                window.addEventListener("test", re, K), window.removeEventListener("test", re, K)
            } catch (e) {}
            var W, V, Y, X, J, G, Z, Q = Date.now || function() {
                ...
                $ = {
                    ...
                    min: function() {
                        return Math.min.apply(null, Se($))
                    },
                    grow: function() {
                        return $.max()
                    },
                    lowestElement: function() {
                        return Math.max($.bodyOffset() || $.documentElementOffset(), _e("bottom", ke()))
                    },
                    taggedElement: function() {
                        return Me("bottom", "data-iframe-height")
                    }
                },
                ee = {
                    bodyScroll: function() {
                    ...
                    max: function() {
                        return Math.max.apply(null, Se(ee))
                    },
                    min: function() {
                        return Math.min.apply(null, Se(ee))
                    },
                    rightMostElement: function() {
                        return _e("right", ke())
                    },
                    taggedElement: function() {
                        return Me("right", "data-iframe-width")
                    }
                },
                te = (W = Ee, J = null, G = 0, Z = function() {
                    G = Q(), J = null, X = W.apply(V, Y), J || (V = Y = null)
                }, function() {
                    var e = Q();
                    G || (G = e);
                    var t = B - (e - G);
                    return V = this, Y = arguments, t <= 0 || t > B ? (J && (clearTimeout(J), J = null), G = e, X = W.apply(V, Y), J || (V = Y = null)) : J || (J = setTimeout(Z, t)), X
                });
            ne(window, "message", Ce), ne(window, "readystatechange", Pe), Pe()
        }

        function re() {}

        function ne(e, t, r, n) {
            e.addEventListener(t, r, !!H && (n || {}))
        }
        ...
        function ce() {
            ...
            ! function() {
                ...
                var n = g.substr(M).split(":");
                k = n[0], a = t !== n[1] ? Number(n[1]) : a, c = t !== n[2] ? e(n[2]) : c, _ = t !== n[3] ? e(n[3]) : _, v = t !== n[4] ? Number(n[4]) : v, r = t !== n[6] ? e(n[6]) : r, o = n[7], b = t !== n[8] ? n[8] : b, i = n[9], f = n[10], T = t !== n[11] ? Number(n[11]) : T, y.enable = t !== n[12] && e(n[12]), A = t !== n[13] ? n[13] : A, N = t !== n[14] ? n[14] : N
            }(), se("Initialising iFrame (" + location.href + ")"),
                function() {
                    function e(e, t) {
                        return "function" == typeof e && (se("Setup custom " + t + "CalcMethod"), U[t] = e, e = "custom"), e
                    }
                    "iFrameResizer" in window && Object === window.iFrameResizer.constructor && (t = window.iFrameResizer, se("Reading data from page: " + JSON.stringify(t)), Object.keys(t).forEach(ue, t), D = "onMessage" in t ? t.onMessage : D, q = "onReady" in t ? t.onReady : q, R = "targetOrigin" in t ? t.targetOrigin : R, b = "heightCalculationMethod" in t ? t.heightCalculationMethod : b, N = "widthCalculationMethod" in t ? t.widthCalculationMethod : N, b = e(b, "height"), N = e(N, "width"));
                    var t;
                    se("TargetOrigin for parent set to: " + R)
                }(),
                function() {
                    t === o && (o = a + "px");
                    he("margin", function(e, t) {
                        -1 !== t.indexOf("-") && (fe("Negative CSS value ignored for " + e), t = "");
                        return t
                    }("margin", o))
                }(), he("background", i), he("padding", f), (e = document.createElement("div")).style.clear = "both", e.style.display = "block", e.style.height = "0", document.body.appendChild(e), be(), me(), document.documentElement.style.height = "", document.body.style.height = "", se('HTML & body height set to "auto"'), se("Enable public methods"), L.parentIFrame = {
                    autoResize: function(e) {
                        return !0 === e && !1 === r ? (r = !0, ge()) : !1 === e && !0 === r && (r = !1, ye()), r
                    },
                    close: function() {
                        Te(0, 0, "close"), se("Disable outgoing messages"), x = !1, se("Remove event listener: Message"), ie(window, "message", Ce), !0 === r && ye()
                    },
                    getId: function() {
                        return k
                    },
                    getPageInfo: function(e) {
                        "function" == typeof e ? (z = e, Te(0, 0, "pageInfo")) : (z = function() {}, Te(0, 0, "pageInfoStop"))
                    },
                    moveToAnchor: function(e) {
                        y.findTarget(e)
                    },
                    reset: function() {
                        Re("parentIFrame.reset")
                    },
                    ...
                    setTargetOrigin: function(e) {
                        se("Set targetOrigin: " + e), R = e
                    },
                    size: function(e, t) {
                        var r = (e || "") + (t ? "," + t : "");
                        Ae("size", "parentIFrame.size(" + r + ")", e, t)
                    }
                }, ge(), y = function() {
                    function e(e) {
                        ...
                        return {
                            x: parseInt(r.left, 10) + parseInt(n.x, 10),
                            y: parseInt(r.top, 10) + parseInt(n.y, 10)
                        }
                    }
                    ...
                    function r(r) {
                        ...
                        t !== a ? function(t) {
                            var r = e(t);
                            se("Moving to in page link (#" + n + ") at x: " + r.x + " y: " + r.y), Te(r.y, r.x, "scrollToOffset")
                        }(a) : (se("In page link (#" + n + ") not found in iFrame, so sending to parent"), Te(0, 0, "inPageLink", "#" + n))
                    }

                    function n() {
                        "" !== location.hash && "#" !== location.hash && r(location.href)
                    }
                    y.enable ? Array.prototype.forEach && document.querySelectorAll ? (se("Setting up location.hash handlers"), Array.prototype.forEach.call(document.querySelectorAll('a[href^="#"]'), function(e) {
                        "#" !== e.getAttribute("href") && ne(e, "click", function(e) {
                            e.preventDefault(), r(this.getAttribute("href"))
                        })
                    }), ne(window, "hashchange", n), setTimeout(n, h)) : fe("In page linking not fully supported in this browser! (See README.md for IE8 workaround)") : se("In page linking not enabled");
                    return {
                        findTarget: r
                    }
                }(), Ae("init", "Init message from host page"), q()
        }
        ...
        function ue(e) {
            ...
            if (2 === t.length) {
                var r = "on" + t[0].charAt(0).toUpperCase() + t[0].slice(1);
                this[r] = this[e], delete this[e], fe("Deprecated: '" + e + "' has been renamed '" + r + "'. The old method will be removed in the next major version.")
            }
        }

        function he(e, r) {
            t !== r && "" !== r && "null" !== r && (document.body.style[e] = r, se("Body " + e + ' set to "' + r + '"'))
        }
        ...
        function de(e) {
            var t = {
                ...
                remove: function(e) {
                    var t = F[e];
                    delete F[e], ie(window, e, t)
                }
            };
            e.eventNames && Array.prototype.map ? (e.eventName = e.eventNames[0], e.eventNames.map(t[e.method])) : t[e.method](e.eventName), se(ae(e.method) + " event listener: " + e.eventType)
        }
        ...
        function pe(e, t, r, n) {
            return t !== e && (e in r || (fe(e + " is not a valid option for " + n + "CalculationMethod."), e = t), se(n + ' calculation method set to "' + e + '"')), e
        }
        ...
        function ge() {
            var e;
            !0 === r ? (le("add"), e = 0 > v, window.MutationObserver || window.WebKitMutationObserver ? e ? ve() : s = function() {
                function e(e) {
                    function t(e) {
                        !1 === e.complete && (se("Attach listeners to " + e.src), e.addEventListener("load", i, !1), e.addEventListener("error", a, !1), f.push(e))
                    }
                ...
                function r(e) {
                    se("Remove listeners from " + e.src), e.removeEventListener("load", i, !1), e.removeEventListener("error", a, !1),
                        function(e) {
                ...
                function n(e, n, i) {
                    r(e.target), Ae(n, i + ": " + e.target.src, t, t)
                }
                ...
                function o(t) {
                    Ae("mutationObserver", "mutationObserver: " + t[0].target + " " + t[0].type), t.forEach(e)
                }
                var s, f = [],
                    c = window.MutationObserver || window.WebKitMutationObserver,
                    u = (s = document.querySelector("body"), u = new c(o), se("Create body MutationObserver"), u.observe(s, {
                        attributes: !0,
                        attributeOldValue: !1,
                        characterData: !0,
                        characterDataOldValue: !1,
                ...
                return {
                    disconnect: function() {
                        "disconnect" in u && (se("Disconnect body MutationObserver"), u.disconnect(), f.forEach(r))
                    }
                }
            }() : (se("MutationObserver not supported in this browser!"), ve())) : se("Auto Resize disabled")
        }

        function ye() {
            le("remove"), null !== s && s.disconnect(), clearInterval(w)
        }

        function ve() {
            0 !== v && (se("setInterval: " + v + "ms"), w = setInterval(function() {
                Ae("interval", "setInterval: " + v)
            }, Math.abs(v)))
        }

        function we(e, t) {
            var r = 0;
            return t = t || document.body, r = null !== (r = document.defaultView.getComputedStyle(t, null)) ? r[e] : 0, parseInt(r, n)
        }

        function _e(e, t) {
            for (var r = t.length, n = 0, i = 0, a = ae(e), o = Q(), s = 0; s < r; s++)(n = t[s].getBoundingClientRect()[e] + we("margin" + a, t[s])) > i && (i = n);
            return o = Q() - o, se("Parsed " + r + " HTML elements"), se("Element position calculated in " + o + "ms"),
                function(e) {
                    e > B / 2 && se("Event throttle increased to " + (B = 2 * e) + "ms")
                }(o), i
        }
        ...
        function Me(e, t) {
            ...
            return 0 === r.length && (fe("No tagged elements (" + t + ") found on page"), document.querySelectorAll("body *")), _e(e, r)
        }
        ...
        function Ee(e, r, n, i) {
            ...
            ! function() {
                ...
                return a = t !== n ? n : $[b](), o = t !== i ? i : ee[N](), e(l, a) || c && e(O, o)
            }() && "init" !== e ? e in {
                init: 1,
                interval: 1,
                size: 1
            } || !(b in E || c && N in E) ? e in {
                interval: 1
            } || se("No change in size detected") : Re(r) : (xe(), Te(l = a, O = o, e))
        }

        function Ae(e, t, r, n) {
            C && e in u ? se("Trigger event cancelled: " + e) : (e in {
                reset: 1,
                resetPage: 1,
                init: 1
            } || se("Trigger event: " + t), "init" === e ? Ee(e, t, r, n) : te(e, t, r, n))
        }

        function xe() {
            C || (C = !0, se("Trigger event lock on")), clearTimeout(P), P = setTimeout(function() {
                C = !1, se("Trigger event lock off"), se("--")
            }, h)
        }
        ...
        function Re(e) {
            var t = b;
            b = p, se("Reset trigger event: " + e), xe(), Ie("reset"), b = t
        }

        function Te(e, r, n, i, a) {
            var o;
            !0 === x && (t === a ? a = R : se("Message targetOrigin: " + a), se("Sending message to host page (" + (o = k + ":" + e + ":" + r + ":" + n + (t !== i ? ":" + i : "")) + ")"), I.postMessage(S + o, a))
        }

        function Ce(t) {
            var r = {
                init: function() {
                    g = t.data, I = t.source, ce(), d = !1, setTimeout(function() {
                        m = !1
                    }, h)
                },
                reset: function() {
                    m ? se("Page reset ignored by init") : (se("Page size reset by host page"), Ie("resetPage"))
                },
                resize: function() {
                ...
                pageInfo: function() {
                    var e = i();
                    se("PageInfoFromParent called from parent: " + e), z(JSON.parse(e)), se(" --")
                },
                message: function() {
                    var e = i();
                    se("onMessage called from parent: " + e), D(JSON.parse(e)), se(" --")
                }
            };
            ...
            function o() {
                var i = n();
                i in r ? r[i]() : (void 0 === e || !e.exports) && "iFrameResize" in window || "jQuery" in window && "iFrameResize" in window.jQuery.prototype || a() || fe("Unexpected message (" + t.data + ")")
            }
            S === ("" + t.data).substr(0, M) && (!1 === d ? o() : a() ? r.init() : se('Ignored message of type "' + n() + '". Received before initialization.'))
        }
    ...
    (function(t) {
        ...
        function s(e, t, r, i) {
            var a;
            if ("hmac" === i) a = n.createHmac(r, t).update(e).digest("base64");
            else {
                if ("sign" != i) throw new Error("Algorithm type not recognized");
                a = n.createSign(r).update(e).sign(t, "base64")
            }
            return h(a)
        }

        function f(e) {
            return t.from(c(e), "base64").toString()
        }

        function c(e) {
            return (e += new Array(5 - e.length % 4).join("=")).replace(/\-/g, "+").replace(/_/g, "/")
        }

        function u(e) {
            return h(t.from(e).toString("base64"))
        }

        function h(e) {
            return e.replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, "")
        }
        o.version = "0.5.6", o.decode = function(e, t, r, o) {
            if (!e) throw new Error("No token supplied");
            var u = e.split(".");
            if (3 !== u.length) throw new Error("Not enough or too many segments");
            var h = u[0],
                d = u[1],
                l = u[2],
                p = JSON.parse(f(h)),
                b = JSON.parse(f(d));
            if (!r) {
                !o && /BEGIN( RSA)? PUBLIC KEY/.test(t.toString()) && (o = "RS256");
                var m = i[o || p.alg],
                    g = a[o || p.alg];
                if (!m || !g) throw new Error("Algorithm not supported");
                if (! function(e, t, r, i, a) {
                        if ("hmac" === i) return a === s(e, t, r, i);
                        if ("sign" == i) return n.createVerify(r).update(e).verify(t, c(a), "base64");
                        throw new Error("Algorithm type not recognized")
                    }([h, d].join("."), t, m, g, l)) throw new Error("Signature verification failed");
                if (b.nbf && Date.now() < 1e3 * b.nbf) throw new Error("Token not yet active");
                if (b.exp && Date.now() > 1e3 * b.exp) throw new Error("Token expired")
            }
            return b
        }, o.encode = function(e, t, r, n) {
            if (!t) throw new Error("Require key");
            r || (r = "HS256");
            var o = i[r],
                f = a[r];
            if (!o || !f) throw new Error("Algorithm not supported");
            var c = {
                typ: "JWT",
                alg: r
            };
            n && n.header && function(e, t) {
                for (var r in t) t.hasOwnProperty(r) && (e[r] = t[r])
            }(c, n.header);
            var h = [];
            return h.push(u(JSON.stringify(c))), h.push(u(JSON.stringify(e))), h.push(s(h.join("."), t, o, f)), h.join(".")
        }
    }).call(t, r(4).Buffer)
}, function(e, t, r) {
    "use strict";
    t.byteLength = function(e) {
        ...
        for (var t, r = c(e), n = r[0], o = r[1], s = new a(function(e, t, r) {
                return 3 * (t + r) / 4 - r
            }(0, n, o)), f = 0, u = o > 0 ? n - 4 : n, h = 0; h < u; h += 4) t = i[e.charCodeAt(h)] << 18 | i[e.charCodeAt(h + 1)] << 12 | i[e.charCodeAt(h + 2)] << 6 | i[e.charCodeAt(h + 3)], s[f++] = t >> 16 & 255, s[f++] = t >> 8 & 255, s[f++] = 255 & t;
        2 === o && (t = i[e.charCodeAt(h)] << 2 | i[e.charCodeAt(h + 1)] >> 4, s[f++] = 255 & t);
        1 === o && (t = i[e.charCodeAt(h)] << 10 | i[e.charCodeAt(h + 1)] << 4 | i[e.charCodeAt(h + 2)] >> 2, s[f++] = t >> 8 & 255, s[f++] = 255 & t);
        return s
    }, t.fromByteArray = function(e) {
        for (var t, r = e.length, i = r % 3, a = [], o = 0, s = r - i; o < s; o += 16383) a.push(u(e, o, o + 16383 > s ? s : o + 16383));
        1 === i ? (t = e[r - 1], a.push(n[t >> 2] + n[t << 4 & 63] + "==")) : 2 === i && (t = (e[r - 2] << 8) + e[r - 1], a.push(n[t >> 10] + n[t >> 4 & 63] + n[t << 2 & 63] + "="));
        return a.join("")
    };
    for (var n = [], i = [], a = "undefined" != typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = 0, f = o.length; s < f; ++s) n[s] = o[s], i[o.charCodeAt(s)] = s;
    ...
    t.read = function(e, t, r, n, i) {
        var a, o, s = 8 * i - n - 1,
            ...
            d = r ? -1 : 1,
            l = e[t + h];
        for (h += d, a = l & (1 << -u) - 1, l >>= -u, u += s; u > 0; a = 256 * a + e[t + h], h += d, u -= 8);
        for (o = a & (1 << -u) - 1, a >>= -u, u += n; u > 0; o = 256 * o + e[t + h], h += d, u -= 8);
        if (0 === a) a = 1 - c;
        else {
        ...
        var o, s, f, c = 8 * a - i - 1,
            ...
            p = n ? 1 : -1,
            b = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (s = isNaN(t) ? 1 : 0, o = u) : (o = Math.floor(Math.log(t) / Math.LN2), t * (f = Math.pow(2, -o)) < 1 && (o--, f *= 2), (t += o + h >= 1 ? d / f : d * Math.pow(2, 1 - h)) * f >= 2 && (o++, f /= 2), o + h >= u ? (s = 0, o = u) : o + h >= 1 ? (s = (t * f - 1) * Math.pow(2, i), o += h) : (s = t * Math.pow(2, h - 1) * Math.pow(2, i), o = 0)); i >= 8; e[r + l] = 255 & s, l += p, s /= 256, i -= 8);
        for (o = o << i | s, c += i; c > 0; e[r + l] = 255 & o, l += p, o /= 256, c -= 8);
        e[r + l - p] |= 128 * b
    }
}, function(e, t, r) {
    "use strict";
    t.randomBytes = t.rng = t.pseudoRandomBytes = t.prng = r(13), t.createHash = t.Hash = r(16), t.createHmac = t.Hmac = r(54);
    var n = r(114),
        i = Object.keys(n),
    ...
    var c = r(138);
    t.createSign = c.createSign, t.Sign = c.Sign, t.createVerify = c.createVerify, t.Verify = c.Verify, t.createECDH = r(172);
    var u = r(173);
    ...
    i.inherits = r(1), i.inherits(a, n), a.prototype._transform = function(e, t, r) {
        r(null, e)
    }
}, function(e, t, r) {
    e.exports = r(33)
    ...
    (function(t, n) {
        ...
        e.exports = function(e, r, l, p, b, m) {
            ...
            if (a(e, r, l, p), "function" != typeof m) throw new Error("No callback provided to pbkdf2");
            f.isBuffer(e) || (e = f.from(e, o)), f.isBuffer(r) || (r = f.from(r, o)),
                function(e, t) {
                    e.then(function(e) {
                        n.nextTick(function() {
                            t(null, e)
    ...
    i(f, s), e.exports = f, f.create = function(e) {
        return new f(e)
    };
    ...
    function l(e, t, r) {
        ...
        return "stream" === s.type ? new o(s.module, t, r) : "auth" === s.type ? new i(s.module, t, r) : new u(s.module, t, r)
    }
    u.prototype._final = function() {
    ...
    function i(e, t, r) {
        for (var n, i, o, s = -1, f = 0; ++s < 8;) n = e._cipher.encryptBlock(e._prev), i = t & 1 << 7 - s ? 128 : 0, f += (128 & (o = n[0] ^ i)) >> s % 8, e._prev = a(e._prev, r ? i : o);
        return f
    }
    ...
    function d(e, t, r) {
        ...
        return "stream" === s.type ? new o(s.module, t, r, !0) : "auth" === s.type ? new n(s.module, t, r, !0) : new u(s.module, t, r)
    }
    r(1)(u, s), u.prototype._update = function(e) {
        var t, r;
        this._cache.add(e);
    ...
    (function(t) {
        ...
        }), a(c, i.Writable), c.prototype._write = function(e, t, r) {
        ...
        }, a(u, i.Writable), u.prototype._write = function(e, t, r) {
            this._hash.update(e), r()
    ...
    (function(t) {
        ...
        function c(e, r, i, a) {
            ...
            c.fill(1);
            var h = new t(s);
            return h.fill(0), h = n(a, h).update(c).update(new t([0])).update(e).update(f).digest(), c = n(a, h).update(c).digest(), {
        ...
        function h(e, r, i) {
            var a, o;
            do {
                for (a = new t(0); 8 * a.length < e.bitLength();) r.v = n(i, r.k).update(r.v).digest(), a = t.concat([a, r.v]);
                o = u(a, e), r.k = n(i, r.k).update(r.v).update(new t([0])).digest(), r.v = n(i, r.k).update(r.v).digest()
            } while (-1 !== o.cmp(e));
            return o
        }
        ...
        e.exports = function(e, r, n, l, p) {
            ...
            if ("dsa" === b.type) {
                ...
                return function(e, r, n) {
                    for (var i, a = r.params.priv_key, s = r.params.p, f = r.params.q, l = r.params.g, p = new o(0), b = u(e, f).mod(f), m = !1, g = c(a, f, e, n); !1 === m;) i = h(f, g, n), p = d(l, i, s, f), 0 === (m = i.invm(f).imul(b.add(a.mul(p))).mod(f)).cmpn(0) && (m = !1, p = new o(0));
                    return function(e, r) {
    ...
    e.exports = {
        _args: [
            ["elliptic@6.5.0", "/var/www/paywall"]
        ],
        _development: !0,
    ...
    a(f, o), e.exports = f, f.prototype._getEndomorphism = function(e) {
        ...
        for (var t, r, n, a, o, s, f, c, u, h = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), d = e, l = this.n.clone(), p = new i(1), b = new i(0), m = new i(0), g = new i(1), y = 0; 0 !== d.cmpn(0);) {
            var v = l.div(d);
            c = l.sub(v.mul(d)), u = m.sub(v.mul(p));
            var w = g.sub(v.mul(b));
            if (!n && c.cmp(h) < 0) t = f.neg(), r = p, n = c.neg(), a = u;
            else if (n && 2 == ++y) break;
            f = c, l = d, d = c, m = p, p = u, g = b, b = w
        }
        o = c.neg(), s = u;
        ...
        for (var c = this._wnafMulAdd(1, n, i, 2 * a, r), u = 0; u < 2 * a; u++) n[u] = null, i[u] = null;
        return c
    }, a(c, o.BasePoint), f.prototype.point = function(e, t, r) {
        ...
        return e = new i(e, 16), this._hasDoubles(e) ? this.curve._fixedNafMul(this, e) : this.curve.endo ? this.curve._endoWnafMulAdd([this], [e]) : this.curve._wnafMul(this, e)
    ...
    }, a(u, o.BasePoint), f.prototype.jpoint = function(e, t, r) {
        ...
        for (r = 0; r < e; r++) {
            ...
            var y = c.redMul(s);
            r + 1 < e && (f = f.redMul(d)), a = b, s = y, c = g
        }
        ...
        if (this.zOne) {
            ...
            var s = n.redAdd(n).redIAdd(n),
                ...
                c = a.redIAdd(a);
            c = (c = c.redIAdd(c)).redIAdd(c), e = f, t = s.redMul(o.redISub(f)).redISub(c), r = this.y.redAdd(this.y)
        } else {
            var u = this.x.redSqr(),
                h = this.y.redSqr(),
                d = h.redSqr(),
        ...
        if (this.zOne) {
            ...
            e = f;
            var c = a.redIAdd(a);
            c = (c = c.redIAdd(c)).redIAdd(c), t = s.redMul(o.redISub(f)).redISub(c), r = this.y.redAdd(this.y)
        } else {
            var u = this.z.redSqr(),
                h = this.y.redSqr(),
                d = this.x.redMul(h),
    ...
    a(f, o), e.exports = f, f.prototype._mulA = function(e) {
        ...
        return 0 === n.cmp(i)
    }, a(c, o.BasePoint), f.prototype.pointFromJSON = function(e) {
        ...
        if (this.curve.twisted) {
            ...
            if (this.zOne) e = n.redSub(i).redSub(a).redMul(o.redSub(this.curve.two)), t = o.redMul(c.redSub(a)), r = o.redSqr().redSub(o).redSub(o);
            else {
                var s = this.z.redSqr(),
                    f = o.redSub(s).redISub(s);
                e = n.redSub(i).redISub(a).redMul(f), t = o.redMul(c.redSub(a)), r = o.redMul(f)
            }
        } else {
            var c = i.redAdd(a);
            s = this.curve._mulC(this.z).redSqr(), f = c.redSub(s).redSub(s);
            e = this.curve._mulC(n.redISub(c)).redMul(f), t = this.curve._mulC(c).redMul(i.redISub(a)), r = c.redMul(f)
        }
        ...
        return this.curve.twisted ? (t = n.redMul(c).redMul(o.redSub(this.curve._mulA(a))), r = f.redMul(c)) : (t = n.redMul(c).redMul(o.redSub(a)), r = this.curve._mulC(f).redMul(c)), this.curve.point(h, t, r)
    }, c.prototype.add = function(e) {
    ...
    "use strict";
    t.sha1 = r(145), t.sha224 = r(146), t.sha256 = r(71), t.sha384 = r(147), t.sha512 = r(72)
}, function(e, t, r) {
    "use strict";
    var n = r(8),
        i = r(19),
    ...
    n.inherits(d, u), e.exports = d, d.blockSize = 512, d.outSize = 160, d.hmacStrength = 80, d.padLength = 64, d.prototype._update = function(e, t) {
        ...
        this.h[0] = s(this.h[0], i), this.h[1] = s(this.h[1], a), this.h[2] = s(this.h[2], u), this.h[3] = s(this.h[3], d), this.h[4] = s(this.h[4], l)
    ...
    n.inherits(u, c), t.ripemd160 = u, u.blockSize = 512, u.outSize = 160, u.hmacStrength = 192, u.padLength = 64, u.prototype._update = function(e, t) {
        for (var r = this.h[0], n = this.h[1], i = this.h[2], c = this.h[3], u = this.h[4], y = r, v = n, w = i, _ = c, S = u, M = 0; M < 80; M++) {
            var k = o(a(f(r, h(M, n, i, c), e[p[M] + t], d(M)), m[M]), u);
            r = u, u = c, c = a(i, 10), i = n, n = k, k = o(a(f(y, h(79 - M, v, w, _), e[b[M] + t], l(M)), g[M]), S), y = S, S = _, _ = a(w, 10), w = v, v = k
        }
        k = s(this.h[1], i, _), this.h[1] = s(this.h[2], c, S), this.h[2] = s(this.h[3], u, y), this.h[3] = s(this.h[4], r, v), this.h[4] = s(this.h[0], n, w), this.h[0] = k
    ...
    function s(e, t) {
        var r = e[t.place++];
        if (!(128 & r)) return r;
        for (var n = 15 & r, i = 0, a = 0, o = t.place; a < n; a++, o++) i <<= 8, i |= e[o];
        return t.place = o, i
    }
    ...
    e.exports = o, o.prototype._importDER = function(e, t) {
        ...
        return 0 === o[0] && 128 & o[1] && (o = o.slice(1)), 0 === c[0] && 128 & c[1] && (c = c.slice(1)), this.r = new n(o), this.s = new n(c), this.recoveryParam = null, !0
    ...
    t.define = function(e, t) {
        ...
        var t;
        try {
            t = r(160).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (e) {
            t = function(e) {
                this._initNamed(e)
            }
    ...
    c.prototype.clone = function() {
        ...
        if (r.obj && o && (n = e.enterObject()), o) {
            ...
            if (t && t.track && null !== r.tag && t.track(e.path(), h, e.length, "tagged"), t && t.track && null !== r.tag && t.track(e.path(), e.offset, e.length, "content"), i = r.any ? i : null === r.choice ? this._decodeGeneric(r.tag, e, t) : this._decodeChoice(e, t), e.isError(i)) return i;
        ...
        if (!i.any && null === i.choice) {
            ...
            null === c ? null === i.use && t.error("Tag could be omitted only for .use()") : null === i.use && (a = this._encodeComposite(c, s, u, o))
        }
    ...
    var n = r(20),
        ...
        l = n.define("TBSCertificate", function() {
            this.seq().obj(this.key("version").explicit(0).int().optional(), this.key("serialNumber").int(), this.key("signature").use(o), this.key("issuer").use(u), this.key("validity").use(h), this.key("subject").use(u), this.key("subjectPublicKeyInfo").use(s), this.key("issuerUniqueID").implicit(1).bitstr().optional(), this.key("subjectUniqueID").implicit(2).bitstr().optional(), this.key("extensions").explicit(3).seqof(d).optional())
        }),
        ...
        e.exports = function(e, r, f, c, u) {
            ...
            if ("dsa" === h.type) {
                ...
                return function(e, t, r) {
                    ...
                    var l = n.mont(i),
                        p = h.invm(o);
                    return 0 === f.toRed(l).redPow(new n(t).mul(p).mod(o)).fromRed().mul(c.toRed(l).redPow(d.mul(p).mod(o)).fromRed()).mod(i).mod(o).cmp(d)
                }(e, r, h)
            }
            ...
            e = (e = new n(e).toRed(m)).redPow(new n(h.publicExponent)), e = new t(e.fromRed().toArray());
            var g = p < 8 ? 1 : 0;
    ...
    t.publicEncrypt = r(174), t.privateDecrypt = r(175), t.privateEncrypt = function(e, r) {
    ...
    var n = r(178),
        ...
        s = r(184),
        f = function(e, t, r) {
            var n = f.getDefaultLang();
            this.input = e || {}, this.messages = i._make(n), this.messages._setCustom(r), this.setAttributeFormatter(f.prototype.attributeFormatter), this.errors = new a, this.errorCount = 0, this.hasAsync = !1, this.rules = this._parseRules(t)
        };
    f.prototype = {
        constructor: f,
        lang: "en",
        numericRules: ["integer", "numeric"],
        attributeFormatter: o.formatter,
        check: function() {
            for (var e in this.rules) {
                var t = this.rules[e],
                    r = this._objectPath(this.input, e);
                if (!this._hasRule(e, ["sometimes"]) || this._suppliedWithData(e))
                    for (var n, i, a, o = 0, s = t.length; o < s && (i = t[o], n = this.getRule(i.name), !this._isValidatable(n, r) || ((a = n.validate(r, i.value, e)) || this._addFailure(n), !this._shouldStopValidating(e, a))); o++);
            }
        ...
        checkAsync: function(e, t) {
            ...
            var n = new s(function(e, t) {
                ...
                i = function(e, t, r, i) {
                    return function() {
                        var a = n.add(i);
                        i.validate(e, t.value, r, function() {
                            n.resolve(a)
                        })
                    }
                };
            for (var a in this.rules) {
                var o = this.rules[a],
                    f = this._objectPath(this.input, a);
                if (!this._hasRule(a, ["sometimes"]) || this._suppliedWithData(a))
                    for (var c, u, h = 0, d = o.length; h < d; h++) u = o[h], c = this.getRule(u.name), this._isValidatable(c, f) && i(f, u, a, c)()
            }
            n.enableFiring(), n.fire()
        },
        ...
        _flattenObject: function(e) {
            ...
            return e && function e(r, n) {
                if (n || 0 !== Object.getOwnPropertyNames(r).length)
                    if (Object(r) !== r || Array.isArray(r)) t[n] = r;
                    else {
                        var i = !0;
                        for (var a in r) i = !1, e(r[a], n ? n + "." + a : a);
                        i && (t[n] = {})
                    }
            }(e), t
        },
        _objectPath: function(e, t) {
            ...
            var r = t.replace(/\[(\w+)\]/g, ".$1").replace(/^\./, "").split("."),
                n = {};
            for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (n[i] = e[i]);
            for (var a = 0, o = r.length; a < o; a++) {
                if (!Object.hasOwnProperty.call(n, r[a])) return;
                n = n[r[a]]
            }
            return n
        },
        _parseRules: function(e) {
            var t = {};
            for (var r in e = this._flattenObject(e)) {
                var n = e[r];
                this._parseRulesCheck(r, n, t)
            }
            return t
        },
        _parseRulesCheck: function(e, t, r, n) {
            e.indexOf("*") > -1 ? this._parsedRulesRecurse(e, t, r, n) : this._parseRulesDefault(e, t, r, n)
        },
        _parsedRulesRecurse: function(e, t, r, n) {
            var i = e.substr(0, e.indexOf("*") - 1),
                a = this._objectPath(this.input, i);
            if (a)
                for (var o = 0; o < a.length; o++) {
                    var s = n ? n.slice() : [];
                    s.push(o), this._parseRulesCheck(e.replace("*", o), t, r, s)
                }
        },
        _parseRulesDefault: function(e, t, r, i) {
            var a = [];
            t instanceof Array && (t = this._prepareRulesArray(t)), "string" == typeof t && (t = t.split("|"));
            for (var o, s = 0, f = t.length; s < f; s++)(o = "string" == typeof t[s] ? this._extractRuleAndRuleValue(t[s]) : t[s]).value && (o.value = this._replaceWildCards(o.value, i), this._replaceWildCardsMessages(i)), n.isAsync(o.name) && (this.hasAsync = !0), a.push(o);
            r[e] = a
        },
        _replaceWildCards: function(e, t) {
            ...
            return t.forEach(function(e) {
                if (Array.isArray(r) && (r = r[0]), pos = r.indexOf("*"), -1 === pos) return r;
                r = r.substr(0, pos) + e + r.substr(pos + 1)
            }), Array.isArray(e) && (e[0] = r, r = e), r
        },
        _replaceWildCardsMessages: function(e) {
            var t = this.messages.customMessages,
                r = this;
            Object.keys(t).forEach(function(n) {
                if (e) {
                    var i = r._replaceWildCards(n, e);
                    t[i] = t[n]
                }
        ...
        _extractRuleAndRuleValue: function(e) {
            var t, r = {};
            return r.name = e, e.indexOf(":") >= 0 && (t = e.split(":"), r.name = t[0], r.value = t.slice(1).join(":")), r
        },
        _hasRule: function(e, t) {
            for (var r = this.rules[e] || [], n = 0, i = r.length; n < i; n++)
                if (t.indexOf(r[n].name) > -1) return !0;
            return !1
        },
        ...
        _isValidatable: function(e, t) {
            return !!n.isImplicit(e.name) || this.getRule("required").validate(t)
        },
        _shouldStopValidating: function(e, t) {
            var r = this.stopOnAttributes;
            return void 0 !== r && !1 !== r && !0 !== t && (!(r instanceof Array) || r.indexOf(e) > -1)
        },
        ...
        fails: function(e) {
            return this._checkAsync("fails", e) ? this.checkAsync(function() {}, e) : !this.check()
        },
        _checkAsync: function(e, t) {
            var r = "function" == typeof t;
            if (this.hasAsync && !r) throw e + " expects a callback when async rules are being tested.";
            return this.hasAsync || r
        }
    }, f.setMessages = function(e, t) {
        return i._set(e, t), this
    }, f.getMessages = function(e) {
        return i._get(e)
    }, f.useLang = function(e) {
        this.prototype.lang = e
    }, f.getDefaultLang = function() {
        return this.prototype.lang
    }, f.setAttributeFormatter = function(e) {
        this.prototype.attributeFormatter = e
    }, f.stopOnError = function(e) {
        this.prototype.stopOnAttributes = e
    }, f.register = function(e, t, r) {
        var a = f.getDefaultLang();
        n.register(e, t), i._setRuleMessage(a, e, r)
    }, f.registerImplicit = function(e, t, r) {
        var a = f.getDefaultLang();
        n.registerImplicit(e, t), i._setRuleMessage(a, e, r)
    }, f.registerAsync = function(e, t, r) {
        var a = f.getDefaultLang();
        n.registerAsync(e, t), i._setRuleMessage(a, e, r)
    }, f.registerAsyncImplicit = function(e, t, r) {
        var a = f.getDefaultLang();
        n.registerAsyncImplicit(e, t), i._setRuleMessage(a, e, r)
    }, f.registerMissedRuleValidator = function(e, t) {
        n.registerMissedRuleValidator(e, t)
    }, e.exports = f
}, function(e, t) {
    function r(e) {
        if ("string" == typeof e) {
            var t = e.indexOf(".");
            t > 0 && t <= 6 && (e = e.replace(/\./g, "-"))
        }
        var r, n = new Date(e),
            i = n.getFullYear(),
            a = n.getMonth(),
            o = n.getDate(),
            s = [31, (r = i, r % 4 == 0 && r % 100 != 0 || r % 400 == 0 ? 29 : 28), 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
        return !(i < 1e3) && (!isNaN(a) && (!(a + 1 > 12) && (!isNaN(o) && !(o > s[a]))))
    }
    var n, i = {
            required: function(e) {
                return void 0 !== e && null !== e && String(e).replace(/\s/g, "").length > 0
            },
            required_if: function(e, t, r) {
            ...
            required_unless: function(e, t, r) {
                return t = this.getParameters(), this.validator._objectPath(this.validator.input, t[0]) === t[1] || this.validator.getRule("required").validate(e)
            },
            required_with: function(e, t, r) {
                return !this.validator._objectPath(this.validator.input, t) || this.validator.getRule("required").validate(e)
            },
            required_with_all: function(e, t, r) {
                t = this.getParameters();
                for (var n = 0; n < t.length; n++)
                    if (!this.validator._objectPath(this.validator.input, t[n])) return !0;
                return this.validator.getRule("required").validate(e)
            },
            required_without: function(e, t, r) {
                return !!this.validator._objectPath(this.validator.input, t) || this.validator.getRule("required").validate(e)
            },
            required_without_all: function(e, t, r) {
                t = this.getParameters();
                for (var n = 0; n < t.length; n++)
                    if (this.validator._objectPath(this.validator.input, t[n])) return !0;
                return this.validator.getRule("required").validate(e)
            ...
            in: function(e, t) {
                var r, n;
                if (e && (r = this.getParameters()), e && !(e instanceof Array)) {
                    var i = e;
                    for (n = 0; n < r.length; n++)
                        if ("string" == typeof r[n] && (i = String(e)), i === r[n]) return !0;
                    return !1
                }
                if (e && e instanceof Array)
                    for (n = 0; n < e.length; n++)
                        if (r.indexOf(e[n]) < 0) return !1;
                return !0
            },
            not_in: function(e, t) {
                for (var r = this.getParameters(), n = r.length, i = !0, a = 0; a < n; a++) {
                    var o = e;
                    if ("string" == typeof r[a] && (o = String(e)), o === r[a]) {
                        i = !1;
                        break
                    }
                }
            ...
            confirmed: function(e, t, r) {
                var n = r + "_confirmation";
                return this.validator.input[n] === e
            },
            integer: function(e) {
                return String(parseInt(e, 10)) === String(e)
            },
            digits: function(e, t) {
                return !(!this.validator.getRule("numeric").validate(e) || String(e).length !== parseInt(t))
            },
            regex: function(e, t) {
                var r = /[g|i|m]{1,3}$/,
                    n = t.match(r);
                return n = n ? n[0] : "", t = t.replace(r, "").slice(1, -1), !!(t = new RegExp(t, n)).test(e)
            },
            date: function(e, t) {
                return r(e)
            },
            ...
            after: function(e, t) {
                var n = this.validator.input[t],
                    i = e;
                return !!r(n) && (!!r(i) && new Date(n).getTime() < new Date(i).getTime())
            },
            after_or_equal: function(e, t) {
                var n = this.validator.input[t],
                    i = e;
    ...
    function o(e, t, r) {
        this.name = e, this.fn = t, this.passes = null, this._customMessage = void 0, this.async = r
    }
    o.prototype = {
        validate: function(e, t, r, n) {
            var i = this;
            if (this._setValidatingData(r, e, t), "function" == typeof n) {
                this.callback = n;
                var a = function(e, t) {
                    i.response(e, t)
                };
                return this.async ? this._apply(e, t, r, a) : a(this._apply(e, t, r))
            }
            return this._apply(e, t, r)
        },
        _apply: function(e, t, r, n) {
            return (this.isMissed() ? a : this.fn).apply(this, [e, t, r, n])
        },
        _setValidatingData: function(e, t, r) {
            this.attribute = e, this.inputValue = t, this.ruleValue = r
        },
    ...
    var s = {
        ...
        make: function(e, t) {
            var r = this.isAsync(e),
                n = new o(e, i[e], r);
            return n.setValidator(t), n
        },
        isAsync: function(e) {
            for (var t = 0, r = this.asyncRules.length; t < r; t++)
    ...
    var i = {
        ...
        _setRuleMessage: function(e, t, r) {
            this._load(e), void 0 === r && (r = this.messages[e].def), this.messages[e][t] = r
        },
        _load: function(e) {
        ...
        _make: function(e) {
            return this._load(e), new n(e, this.messages[e])
        }
    };
    e.exports = i
}, function(e, t, r) {
    ...
    i.prototype = {
        ...
        render: function(e) {
            ...
            return n.replacements[e.name] ? n.replacements[e.name].apply(this, [t, e]) : this._replacePlaceholders(e, t, {})
        },
        _getTemplate: function(e) {
            for (var t, r = this.messages, n = r.def, i = this.customMessages, a = [e.name + "." + e.attribute, e.name], o = 0; o < a.length; o++) {
                if (t = a[o], i.hasOwnProperty(t)) {
                    n = i[t];
                    break
                }
            ...
            return "object" == typeof n && (n = n[e._getValueType()]), n
        },
        _replacePlaceholders: function(e, t, r) {
            var n, i;
            if (r.attribute = this._getAttributeName(e.attribute), r[e.name] = r[e.name] || e.getParameters().join(","), "string" == typeof t && "object" == typeof r)
                for (i in n = t, r) n = n.replace(new RegExp(":" + i, "g"), r[i]);
            return n
        }
    }, e.exports = i
}, function(e, t) {
    ...
    }, i.resolve = a, e.exports = i, i.id = 182
}, function(e, t) {
    var r = function() {
        this.errors = {}
    };
    ...
    var s = function() {
        function e() {
            ...
            if (function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), "" === t.paywallUrl || void 0 === t.paywallUrl) throw "Required config: paywallUrl";
            this.paywallUrl = t.paywallUrl;
            var r = this.getSystemConfig(t.paywallUrl),
                n = a({}, r, t);
            this.updateKeys(n)
        }
        return o(e, [{
            ...
            value: function() {
                var e = this;
                if (null !== localStorage.getItem("subscription_config")) return this.getConfigFromLocalStorage();
                this.getConfigFromApi().then(function(t) {
                    e.updateKeys(t)
                })
            }
        }, {
            key: "getConfigFromLocalStorage",
            value: function() {
                return JSON.parse(localStorage.getItem("subscription_config"))
            }
        }, {
            ...
            value: function() {
                var e, t = (e = i.a.mark(function e() {
                    return i.a.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return e.prev = 0, e.next = 3, fetch(this.paywallUrl + "/api/v1/config").then(function(e) {
                                    return e.json()
                                }).then(function(e) {
                                    var t = e.data;
                                    return localStorage.setItem("subscription_config", JSON.stringify(t)), t
                                });
                            case 3:
                                return e.abrupt("return", e.sent);
                            case 6:
                                return e.prev = 6, e.t0 = e.catch(0), console.log(e.t0), e.abrupt("return", {});
                            case 10:
                            case "end":
                                return e.stop()
                        }
            ...
            value: function(e) {
                ...
                e && Object.keys(e).forEach(function(r) {
                    var n = e[r];
                    r = r.replace(/([-_][a-z])/gi, function(e) {
    ...
    var n = r(187);
    e.exports = function(e) {
        if (!(e = e || {}).userAgent && "undefined" == typeof navigator || /(Chromium|OPR|Opera)/.test(e.userAgent || navigator.userAgent)) return !1;
        var t = new RegExp(/(Chrome)\/((\d+)?[\w\.]+)/).exec(e.userAgent || navigator.userAgent);
        return !(!t || e.version && !n(t, e.version))
    }
}, function(e, t, r) {
    "use strict";
    e.exports = function(e, t) {
    ...
    var n = r(189),
        i = new RegExp("(" + n.join("|") + ")", "ig");
    e.exports = function(e) {
        return i.lastIndex = 0, i.test(e)
    }, e.exports.extend = function(e) {
        n = n.concat(e), i = new RegExp("(" + n.join("|") + ")", "ig")
    }
}, function(e, t) {
    e.exports = ["bot", "crawl", "yahoo", "AppEngine-Google", "cXensebot", "facebookexternalhit", "Feedfetcher-Google", "Google Wireless Transcoder", "Google Favicon", "Google Page Speed Insights", "Mediapartners-Google", "g00g1e\\.net", "developers\\.google\\.com\\/\\+\\/web\\/snippet\\/"]
}, , function(e, t, r) {
    "use strict";
    var n = r(12),
        i = function() {
    ...
    var a = r(15),
        ...
        c = function() {
            function e() {
                ...
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this.siteId = r.cxenseSiteId, this.persistedQueryId = r.cxensePersistedQueryId;
                var i = new f,
                    c = window.cX = window.cX || {};
                c.callQueue = c.callQueue || [], c.callQueue.push(["setSiteId", this.siteId]), i.isLogged() ? (c.callQueue.push(["setCustomParameters", {
                    registered: "true"
                }]), Object(n.d)("Cxense parameter registered: ", !0)) : (c.callQueue.push(["setCustomParameters", {
                    registered: "false"
                }]), Object(n.d)("Cxense parameter registered: ", !1));
                var u, h, d, l, p = function(e) {
                    1 === e ? (c.callQueue.push(["setCustomParameters", {
                        incognito: "true"
                    }]), Object(n.d)("Cxense parameter incognito: ", !0)) : (c.callQueue.push(["setCustomParameters", {
                        incognito: "false"
                    }]), Object(n.d)("Cxense parameter incognito: ", !1))
                };
                s().then(p, p).catch(p), void 0 !== o && o.isDetected() ? (c.callQueue.push(["setCustomParameters", {
                    adblocker: "true"
                }]), Object(n.d)("Cxense parameter adblocker: ", !0)) : (c.callQueue.push(["setCustomParameters", {
                    adblocker: "false"
                }]), Object(n.d)("Cxense parameter adblocker: ", !1)), c.callQueue.push(["invoke", function() {
                    var e = c.getUserSegmentIds({
                        persistedQueryId: t.persistedQueryId
                    });
                    Object(n.d)("Cxense segmentos: ", e);
                    var r = {
                    ...
                    a.set("paywall_segments", e.join(";"), r)
                }]), c.callQueue.push(["sendPageViewEvent"]), this.cx = c, u = document, h = "script", (d = u.createElement(h)).type = "text/java" + h, d.async = "async", d.src = "http" + ("https:" === location.protocol ? "s://s" : "://") + "cdn.cxense.com/cx.js", (l = u.getElementsByTagName(h)[0]).parentNode.insertBefore(d, l)
            }
            return i(e, [{
                key: "getCx",
                value: function() {
    ...
    r(326), r(327), r(328), r(329), r(330), r(331), r(332), r(333), r(334), e.exports = r(335)
}, function(e, t, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var y = function() {
            function e() {
                ...
                var f = {
                    isPreview: !1,
                    persistedQueryId: i.persistedQueryId,
                    events: []
                };
                this.config = m({}, f, t), this.element = t.element, this.auth = r, this.history = o, this.version = "1.0.0", this.segments = {
                    paywall: "8ljwvhubefad",
                    loginwall: "8luze7b0i7p5",
                    incognito: "8nel6yus336y",
                    custom: {
                        15: "8mh7pbqsu758",
                        40: "8n3i5oklnrf9"
                    }
                }, this.meterCookie = "paywall_meter", this.meterLastCheckCookie = "paywall_meter_last_check", this.walls = this.getWalls(), isNaN(s.a.get(this.meterCookie)) ? this.meter = 0 : this.meter = parseInt(s.a.get(this.meterCookie)) || this.meter, this.showingWall = !1, this.wall = null, this.customKey = null, Object(a.d)("Paywall config:", this.config), setTimeout(function() {
                    Object(a.d)("Comprobación segmentos Cxense", n.getSegments())
                }, 100)
            }
            return g(e, [{
                key: "check",
                value: function() {
                    var e = this;
                    s.a.remove("url_metered", {
                        path: "/",
                        domain: Object(a.a)()
                    }), Object(a.c)(this.element, "checking"), this.shouldCheck() && (this.saveUrl(), this.auth.isSubscribed().then(function(t) {
                        if (Object(a.d)("User is subscribed:", t), t) e.metered().then(function(e) {
                            Object(a.d)(e)
                        }).catch(a.b);
                        else {
                            var r = function(t) {
                                1 === t && (e.hasSegment("incognito") || e.meter >= 4) && e.showPaywall("incognito", "Incógnito")
                            };
                            p()().then(r, r).catch(r), e.hasSegment("paywall") && e.showPaywall(null, "Cxense segment"), e.hasSegment("loginwall") && e.showLoginwall("Cxense segment"), e.hasCustomSegment(e.meter) && e.showCustomWall(e.customKey, "Cxense segment"), e.metered().then(function(t) {
                                Object(a.d)(t), e.walls.filter(function(t) {
                                    return t.key <= e.meter
                                }).forEach(function(t) {
                                    void 0 !== t && e.showWall(t, "Metered")
                                })
                            }).catch(a.b)
                        }
                    }), setTimeout(function() {
                        Object(a.c)(e.element, "checked")
                    }, 1))
                }
            }, {
                key: "showWall",
                value: function(e) {
                    ...
                    switch (e.name) {
                        case "paywall":
                            this.showPaywall(null, t);
                            break;
                        case "loginwall":
                            this.showLoginwall(t);
                            break;
                        case "customwall":
                            this.showCustomWall(e.key, t)
                    }
                }
            }, {
                key: "showPaywall",
                value: function(e) {
                    ...
                    Object(a.d)("[" + (r || "sin descripción") + "]"), this.isPaywallDisabled() || this.showingWall || (this.showingWall = !0, this.wall = "paywall", Object(a.c)(this.element, "paywall"), Object(a.d)("Paywall [" + (r || "sin descripción") + "]"), dataLayer.push({
                        event: "SuscriptionVirtualPageview",
                        virtualPageURL: window.location.pathname.replace("/nota", "/paywall")
                    }), setTimeout(function() {
                        window.location = t.config.paywallUrl + "?limit=true" + ("limit" !== e && "" !== e && e ? "&msg=" + e : "")
                    }, 100))
                }
            }, {
                key: "showLoginwall",
                value: function() {
                    ...
                    this.auth.isLogged() || this.showingWall || (Object(a.c)(this.element, "loginwall"), this.showingWall = !0, this.wall = "loginwall", Object(a.d)("Loginwall [" + (e || "sin descripción") + "]"), dataLayer.push({
                        event: "gaEvent",
                        eventCategory: "subscriptions",
                        eventAction: "loginwall",
                        eventLabel: this.meter > 15 ? "hard" : "soft"
                    }))
                }
            }, {
                key: "showCustomWall",
                value: function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                    this.showingWall || (Object(a.d)("Customwall [" + (t || "sin descripción") + "]"), Object(a.c)(this.element, "customwall:" + e), this.showingWall = !0, this.wall = "customwall:" + e)
                }
            }, {
                key: "shouldCheck",
                value: function() {
                    return !this.isPreview() && !d(navigator.userAgent) && !this.isNavigationRole() && this.isNodeEnabled()
                }
            }, {
                key: "isPaywallDisabled",
                value: function() {
                    return "off" === new URLSearchParams(window.location.search).get("paywall")
                }
            }, {
                key: "isPreview",
                value: function() {
                    return Object(a.d)("Is preview:", this.config.isPreview), this.config.isPreview
                }
            }, {
                key: "isNodeEnabled",
                value: function() {
                    var e = this.config.allowedContentTypes.indexOf(this.config.contentType) >= 0 && "free_access" !== this.config.type;
                    return Object(a.d)("Node enabled:", e), e
                }
            }, {
                key: "getWalls",
                value: function() {
                    var e = [{
                            key: this.config.loginwallLimit,
                            name: "loginwall"
                        }, {
                            key: this.config.paywallLimit,
                            name: "paywall"
                        }],
                        t = this.config.events.filter(function(e) {
                            return e.includes("customwall")
                        }).map(function(e) {
                            var t = e.split(":"),
                                r = b(t, 2),
                                n = r[0],
                ...
                key: "hasSegment",
                value: function(e) {
                    return e = this.segments[e] || null, this.getSegments().includes(e)
                }
            }, {
                key: "hasCustomSegment",
                value: function() {
                    var e = this;
                    if (void 0 === this.segments.custom) return !1;
                    var t = Object.keys(this.segments.custom).map(function(e) {
                        return parseInt(e)
                    }).filter(function(t) {
                        return e.getSegments().indexOf(e.segments.custom[t]) > 0
                    }).sort(function(e, t) {
                        return e - t
                    }).pop();
                    return this.customKey = t, void 0 !== t
                }
            }, {
                key: "getSegments",
                value: function() {
                    var e = this;
                    return void 0 !== s.a.get("paywall_segments") ? s.a.get("paywall_segments").split(";") : (cX.callQueue.push(["invoke", function() {
                        var t = cX.getUserSegmentIds({
                            persistedQueryId: e.config.persistedQueryId
                        });
                        if (void 0 !== t && Array.isArray(t)) {
                            var r = {
                                ...
                                sameSite: "None",
                                secure: !e.config.debug
                            };
                            return s.a.set("paywall_segments", t.join(";"), r), t
                        }
                    }]), [])
                }
            }, {
                ...
                value: function() {
                    ...
                    return new Promise(function(t, r) {
                        var n = s.a.get(e.meterLastCheckCookie) ? new Date(s.a.get(e.meterLastCheckCookie)) : new Date,
                            i = new Date,
                            a = new Date(i.getFullYear(), i.getMonth() + 1, i.getDate(), 23, 59),
                            o = Math.floor((i - n) / 864e5),
                            f = Math.floor(e.meter / 30) * o;
                        if (e.history.setUrl()) {
                            e.meter = e.meter - f, e.meter++;
                            var c = {
                                expires: a,
                                domain: e.config.cookieDomain,
                                sameSite: "None",
                            ...
                            s.a.set(e.meterCookie, e.meter, c), (o > 0 || void 0 === s.a.get(e.meterLastCheckCookie)) && s.a.set(e.meterLastCheckCookie, i, c)
                        }
                        t("Meter: " + e.meter)
                    })
                }
            }, {
                key: "isNavigationRole",
                value: function() {
                    var e = this;
                    return !(!this.auth.isLogged() || !this.auth.user().roles || void 0 === this.config.navigationRoles) && this.auth.user().roles.some(function(t) {
                        return e.config.navigationRoles.includes(t)
                    })
                }
            }, {
                key: "saveUrl",
                value: function() {
                    if (-1 === window.location.pathname.indexOf("/usuarios")) {
                        var e = {
                            expires: 1,
                            domain: Object(a.a)(),
                            sameSite: "None",
                        ...
                        s.a.set("paywall_last_article", window.location.pathname, e), s.a.set("paywall_last_article_full", window.location.href, e), s.a.set("paywall_last_article_domain", window.location.host, e), "premium" === this.config.type ? s.a.set("paywall_last_article_premium", window.location.pathname, e) : s.a.remove("paywall_last_article_premium", {
                            path: "/",
                            domain: Object(a.a)()
                        })
                    }
        ...
        E = function() {
            function e() {
                ...
                this.config = w({}, {
                    ...
                    events: [],
                    paywallUrl: ""
                }, t), document.body.classList.add("paywall"), this.element = document.querySelector(".paywall"), Object(a.c)(this.element, "ready"), "object" === (void 0 === r ? "undefined" : v(r)) && Array.isArray(r.queue) && (this.queue = r.queue, this.processQueue()), Object(a.d)("Config: ", this.config), this.auth = n, this.cxense = i, this.history = o, this.paywall = new y(w({
                    element: this.element
                }, this.config), this.auth, this.cxense, this.history), this.config.async || this.paywall.check(), this.cookie = "paywall_user"
            }
            return _(e, [{
                key: "signIn",
                value: function(e) {
                    this.auth.validate(e) && (Object(a.d)("User logged in"), e.checkSubscription = !0, this.auth.login(e))
                }
            }, {
                key: "signOff",
                value: function() {
                    Object(a.d)("User logged out"), this.auth.logout()
                }
            }, {
                key: "registerEvent",
                value: function(e, t) {
                    this.config.events.push(e), this.element.addEventListener("paywall." + e, t)
                }
            }, {
                key: "check",
                value: function() {
                ...
                value: function() {
                    ...
                    this.paywall.showPaywall(e)
                }
            }, {
                key: "showLoginwall",
                value: function() {
                    this.paywall.showLoginwall()
                }
            }, {
                ...
                value: function(e) {
                    ...
                    r.setAttribute("id", "paywall-subscription"), r.setAttribute("width", "100%"), r.setAttribute("style", "width: 1px; min-width: 100%; border: 0;"), r.setAttribute("scrolling", "no"), r.setAttribute("sandbox", "allow-same-origin allow-scripts allow-modals allow-forms allow-top-navigation"), t.appendChild(r), r.src = this.config.paywallUrl + "/mi-suscripcion", setTimeout(function() {
                        k.iframeResizer({
                            log: !1
                        }, r)
                    }, 100)
                ...
                key: "viewSubscriptionData",
                value: function() {
                    var e, t = (e = i.a.mark(function e(t) {
                        return i.a.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.t0 = t, e.next = 3, this.auth.getSubscriptionData();
                                case 3:
    ...
    E.prototype.processQueue = function() {
        var e = this;
        for (Object(a.d)("Processing Queue"); this.queue.length;) {
            var t = M(this.queue.shift()),
                r = t[0],
                n = t.slice(1);
            ! function() {
                switch (r) {
                    case "addEventListener":
                        e.registerEvent.apply(e, S(n));
                        break;
                    case "invoke":
                        var t = M(n),
                            i = t[0],
                        ...
                        setTimeout(function() {
                            try {
                                var t;
                                if (a)(t = e[i]).call.apply(t, [e].concat(S(a)));
                                else e[i].call(e)
                            } catch (e) {}
                        }, 1)
                }
    ...
    var A = w({}, {
            allowedContentTypes: ["news", "nota_periodistica"]
        }, window.paywallConfig),
        x = new c.a(A),
        I = new f.default(x),
        R = new u.a(x),
        T = new h.a;
    window.cX = window.cX || R.getCx(), window.dataLayer = window.dataLayer || [], window.paywall = window.paywall || {}, window.paywall.queue = window.paywall.queue || [], window.paywall.queue.push = function() {
        return Array.prototype.push.apply(this, arguments), setTimeout(window.paywall.processQueue(), 1), this.length
    }, window.paywall = new E(x, paywall, I, R, T)
...
! function(t) {
    ...
    112: function(t, e, r) {
        ...
        var i = function() {
            function t() {
                ...
                }(this, t), this.key = "url_metered", this.maximumDays = 10
            }
            return n(t, [{
                key: "setUrl",
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new URL(window.location.href).pathname,
                        e = this.getUrls();
                ...
                value: function() {
                    var t = this,
                        e = [];
                    return null !== localStorage.getItem(this.key) && (e = JSON.parse(localStorage.getItem(this.key))), e.filter(function(e) {
                        var r = new Date;
                        return r.setDate(r.getDate() - t.maximumDays), new Date(e.t).getTime() >= r.getTime()
                    })
                }
            }, {
                key: "getLastUrl",
                value: function() {
                    var t = this.getUrls();
                    return t.length ? t[t.length - 1].u : null
                }
            }]), t
        }();
        e.a = i
    ...
    113: function(t, e, r) {
        var n = function() {
            ...
            i = n.regeneratorRuntime && Object.getOwnPropertyNames(n).indexOf("regeneratorRuntime") >= 0,
            a = i && n.regeneratorRuntime;
        if (n.regeneratorRuntime = void 0, t.exports = r(114), i) n.regeneratorRuntime = a;
        else try {
            delete n.regeneratorRuntime
        } catch (t) {
            n.regeneratorRuntime = void 0
        ...
        ! function(e) {
            ...
            if (l) c && (t.exports = l);
                ...
                var v = Object.getPrototypeOf,
                    y = v && v(v(R([])));
                y && y !== n && i.call(y, o) && (m = y);
                var b = A.prototype = x.prototype = Object.create(m);
                k.prototype = b.constructor = A, A.constructor = k, A[u] = k.displayName = "GeneratorFunction", l.isGeneratorFunction = function(t) {
                    ...
                    return this
                }, l.AsyncIterator = S, l.async = function(t, e, r, n) {
                    var i = new S(w(t, e, r, n));
                    return l.isGeneratorFunction(e) ? i : i.next().then(function(t) {
                        return t.done ? t.value : i.next()
                    })
                }, O(b), b[u] = "Generator", b[o] = function() {
                    return this
                }, b.toString = function() {
                    return "[object Generator]"
                }, l.keys = function(t) {
            ...
            function P(t, e) {
                ...
                if (n === r) {
                    if (e.delegate = null, "throw" === e.method) {
                        if (t.iterator.return && (e.method = "return", e.arg = r, P(t, e), "throw" === e.method)) return g;
    ...
    115: function(t, e, r) {
        var n = r(116),
            ...
            s = r(122),
            u = function(t, e, r) {
                var n = u.getDefaultLang();
                this.input = t || {}, this.messages = i._make(n), this.messages._setCustom(r), this.setAttributeFormatter(u.prototype.attributeFormatter), this.errors = new a, this.errorCount = 0, this.hasAsync = !1, this.rules = this._parseRules(e)
            };
        u.prototype = {
            constructor: u,
            lang: "en",
            ...
            check: function() {
                for (var t in this.rules) {
                    var e = this.rules[t],
                        r = this._objectPath(this.input, t);
                    if (!this._hasRule(t, ["sometimes"]) || this._suppliedWithData(t))
                        for (var n, i, a, o = 0, s = e.length; o < s && (i = e[o], n = this.getRule(i.name), !this._isValidatable(n, r) || ((a = n.validate(r, i.value, t)) || this._addFailure(n), !this._shouldStopValidating(t, a))); o++);
                }
                return 0 === this.errorCount
            },
            checkAsync: function(t, e) {
                ...
                var n = new s(function(t, e) {
                    ...
                    i = function(t, e, r, i) {
                        return function() {
                            var a = n.add(i);
                            i.validate(t, e.value, r, function() {
                                n.resolve(a)
                            })
                        }
                    };
                for (var a in this.rules) {
                    var o = this.rules[a],
                        u = this._objectPath(this.input, a);
                    if (!this._hasRule(a, ["sometimes"]) || this._suppliedWithData(a))
                        for (var c, l, h = 0, f = o.length; h < f; h++) l = o[h], c = this.getRule(l.name), this._isValidatable(c, u) && i(u, l, a, c)()
                }
                n.enableFiring(), n.fire()
            },
            ...
            _flattenObject: function(t) {
                ...
                return t && function t(r, n) {
                    if (n || 0 !== Object.getOwnPropertyNames(r).length)
                        if (Object(r) !== r || Array.isArray(r)) e[n] = r;
                        else {
                            var i = !0;
                            for (var a in r) i = !1, t(r[a], n ? n + "." + a : a);
                            i && (e[n] = {})
                        }
                }(t), e
            },
            _objectPath: function(t, e) {
                ...
                var r = e.replace(/\[(\w+)\]/g, ".$1").replace(/^\./, "").split("."),
                    n = {};
                for (var i in t) Object.prototype.hasOwnProperty.call(t, i) && (n[i] = t[i]);
                for (var a = 0, o = r.length; a < o; a++) {
                    if ("object" != typeof n || null === n || !Object.hasOwnProperty.call(n, r[a])) return;
                    n = n[r[a]]
                }
                return n
            },
            _parseRules: function(t) {
                var e = {};
                for (var r in t = this._flattenObject(t)) {
                    var n = t[r];
                    this._parseRulesCheck(r, n, e)
                }
                return e
            },
            _parseRulesCheck: function(t, e, r, n) {
                t.indexOf("*") > -1 ? this._parsedRulesRecurse(t, e, r, n) : this._parseRulesDefault(t, e, r, n)
            },
            _parsedRulesRecurse: function(t, e, r, n) {
                var i = t.substr(0, t.indexOf("*") - 1),
                    a = this._objectPath(this.input, i);
                if (a)
                    for (var o = 0; o < a.length; o++) {
                        var s = n ? n.slice() : [];
                        s.push(o), this._parseRulesCheck(t.replace("*", o), e, r, s)
                    }
            },
            _parseRulesDefault: function(t, e, r, i) {
                var a = [];
                e instanceof Array && (e = this._prepareRulesArray(e)), "string" == typeof e && (e = e.split("|"));
                for (var o, s = 0, u = e.length; s < u; s++)(o = "string" == typeof e[s] ? this._extractRuleAndRuleValue(e[s]) : e[s]).value && (o.value = this._replaceWildCards(o.value, i), this._replaceWildCardsMessages(i)), n.isAsync(o.name) && (this.hasAsync = !0), a.push(o);
                r[t] = a
            },
            _replaceWildCards: function(t, e) {
                ...
                return e.forEach(function(t) {
                    ...
                    const e = r.indexOf("*");
                    if (-1 === e) return r;
                    r = r.substr(0, e) + t + r.substr(e + 1)
                }), Array.isArray(t) && (t[0] = r, r = t), r
            },
            ...
            _extractRuleAndRuleValue: function(t) {
                var e, r = {};
                return r.name = t, t.indexOf(":") >= 0 && (e = t.split(":"), r.name = e[0], r.value = e.slice(1).join(":")), r
            },
            _hasRule: function(t, e) {
                for (var r = this.rules[t] || [], n = 0, i = r.length; n < i; n++)
                    if (e.indexOf(r[n].name) > -1) return !0;
                return !1
            },
            ...
            _isValidatable: function(t, e) {
                return !!Array.isArray(e) || (!!n.isImplicit(t.name) || this.getRule("required").validate(e))
            },
            _shouldStopValidating: function(t, e) {
                var r = this.stopOnAttributes;
                return void 0 !== r && !1 !== r && !0 !== e && (!(r instanceof Array) || r.indexOf(t) > -1)
            },
            ...
            getRule: function(t) {
                return n.make(t, this)
            },
            stopOnError: function(t) {
                this.stopOnAttributes = t
            },
            passes: function(t) {
                return this._checkAsync("passes", t) ? this.checkAsync(t) : this.check()
            },
            fails: function(t) {
                return this._checkAsync("fails", t) ? this.checkAsync(function() {}, t) : !this.check()
            },
            _checkAsync: function(t, e) {
                var r = "function" == typeof e;
                if (this.hasAsync && !r) throw t + " expects a callback when async rules are being tested.";
                return this.hasAsync || r
            }
        }, u.setMessages = function(t, e) {
            return i._set(t, e), this
        }, u.getMessages = function(t) {
            return i._get(t)
        }, u.useLang = function(t) {
            this.prototype.lang = t
        }, u.getDefaultLang = function() {
            return this.prototype.lang
        }, u.setAttributeFormatter = function(t) {
            this.prototype.attributeFormatter = t
        }, u.stopOnError = function(t) {
            this.prototype.stopOnAttributes = t
        }, u.register = function(t, e, r, a) {
            var o = u.getDefaultLang();
            n.register(t, e), i._setRuleMessage(o, t, r)
        }, u.registerImplicit = function(t, e, r, a) {
            var o = u.getDefaultLang();
            n.registerImplicit(t, e), i._setRuleMessage(o, t, r)
        }, u.registerAsync = function(t, e, r, a) {
            var o = u.getDefaultLang();
            n.registerAsync(t, e), i._setRuleMessage(o, t, r)
        }, u.registerAsyncImplicit = function(t, e, r) {
            var a = u.getDefaultLang();
            n.registerAsyncImplicit(t, e), i._setRuleMessage(a, t, r)
        }, u.registerMissedRuleValidator = function(t, e) {
            n.registerMissedRuleValidator(t, e)
        }, t.exports = u
    },
    116: function(t, e) {
        function r(t) {
            let e;
            if ("number" == typeof t && "object" == typeof(e = new Date(t))) return !0;
            if ("object" == typeof(e = new Date(t))) return "Invalid Date" !== e.toString() && !! function(t = "") {
                if (10 === t.length) {
                    let r = t.replace(".", "-").replace("/", "-").split("-");
                    if (3 === r.length && 4 === r[0].length) {
                        let t = parseInt(r[0]),
                            n = parseInt(r[1]),
                            i = parseInt(r[2]);
                        if (2 === n)
                            if ((e = t) % 4 == 0 && e % 100 != 0 || e % 400 == 0) {
                                if (i > 29) return !1
                            } else if (i > 28) return !1;
                        if ((4 === n || 6 === n || 9 === n || 11 === n) && i > 30) return !1
                    }
                    return !0
                }
                var e;
            ...
            var r = t.split("-"),
                ...
                i = parseInt(r[1], 10),
                a = parseInt(r[0], 10);
            if (a < 1e3 || a > 3e3 || 0 == i || i > 12) return !1;
            var o = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
            return (a % 400 == 0 || a % 100 != 0 && a % 4 == 0) && (o[1] = 29), n > 0 && n <= o[i - 1]
        }
        var n, i = {
                required: function(t) {
                    return void 0 !== t && null !== t && String(t).replace(/\s/g, "").length > 0
                },
                required_if: function(t, e, r) {
                    return e = this.getParameters(), this.validator._objectPath(this.validator.input, e[0]) !== e[1] || this.validator.getRule("required").validate(t)
                },
                required_unless: function(t, e, r) {
                    return e = this.getParameters(), this.validator._objectPath(this.validator.input, e[0]) === e[1] || this.validator.getRule("required").validate(t)
                },
                required_with: function(t, e, r) {
                    return !this.validator._objectPath(this.validator.input, e) || this.validator.getRule("required").validate(t)
                },
                required_with_all: function(t, e, r) {
                    e = this.getParameters();
                    for (var n = 0; n < e.length; n++)
                        if (!this.validator._objectPath(this.validator.input, e[n])) return !0;
                    return this.validator.getRule("required").validate(t)
                },
                required_without: function(t, e, r) {
                    return !!this.validator._objectPath(this.validator.input, e) || this.validator.getRule("required").validate(t)
                },
                required_without_all: function(t, e, r) {
                    e = this.getParameters();
                    for (var n = 0; n < e.length; n++)
                        if (this.validator._objectPath(this.validator.input, e[n])) return !0;
                    return this.validator.getRule("required").validate(t)
                ...
                boolean: function(t) {
                    return !0 === t || !1 === t || 0 === t || 1 === t || "0" === t || "1" === t || "true" === t || "false" === t
                },
                size: function(t, e, r) {
                    return !t || (e = parseFloat(e), this.getSize() === e)
                },
                string: function(t, e, r) {
                ...
                email: function(t) {
                    ...
                    return e.test(t) || (e = /^((?:[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]|[^\u0000-\u007F])+@(?:[a-zA-Z0-9]|[^\u0000-\u007F])(?:(?:[a-zA-Z0-9-]|[^\u0000-\u007F]){0,61}(?:[a-zA-Z0-9]|[^\u0000-\u007F]))?(?:\.(?:[a-zA-Z0-9]|[^\u0000-\u007F])(?:(?:[a-zA-Z0-9-]|[^\u0000-\u007F]){0,61}(?:[a-zA-Z0-9]|[^\u0000-\u007F]))?))*$/), e.test(t)
                },
                numeric: function(t) {
                    var e;
                    return "number" == typeof(e = Number(t)) && !isNaN(e) && "boolean" != typeof t
                },
                array: function(t) {
                    return t instanceof Array
                },
                url: function(t) {
                    return /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_\+.~#?&/=]*)/i.test(t)
                },
                alpha: function(t) {
                ...
                same: function(t, e) {
                    return this.validator._flattenObject(this.validator.input)[e] === t
                },
                ...
                in: function(t, e) {
                    var r, n;
                    if (t && (r = this.getParameters()), t && !(t instanceof Array)) {
                        var i = t;
                        for (n = 0; n < r.length; n++)
                            if ("string" == typeof r[n] && (i = String(t)), i === r[n]) return !0;
                        return !1
                    }
                    if (t && t instanceof Array)
                        for (n = 0; n < t.length; n++)
                            if (r.indexOf(t[n]) < 0) return !1;
                    return !0
                },
                not_in: function(t, e) {
                    for (var r = this.getParameters(), n = r.length, i = !0, a = 0; a < n; a++) {
                        var o = t;
                        if ("string" == typeof r[a] && (o = String(t)), o === r[a]) {
                            i = !1;
                            break
                        }
                    }
                ...
                accepted: function(t) {
                    return "on" === t || "yes" === t || 1 === t || "1" === t || !0 === t
                },
                confirmed: function(t, e, r) {
                    var n = r + "_confirmation";
                ...
                digits: function(t, e) {
                    return !(!this.validator.getRule("numeric").validate(t) || String(t.trim()).length !== parseInt(e))
                },
                digits_between: function(t) {
                    var e = this.validator.getRule("numeric"),
                        ...
                        i = parseFloat(r[0], 10),
                        a = parseFloat(r[1], 10);
                    return !!(e.validate(t) && n >= i && n <= a)
                },
                regex: function(t, e) {
                    var r = /[g|i|m]{1,3}$/,
                        n = e.match(r);
                    return n = n ? n[0] : "", e = e.replace(r, "").slice(1, -1), !!(e = new RegExp(e, n)).test(t)
                },
                date: function(t, e) {
                    return r(t)
                },
                ...
                ipv6: function(t, e, r) {
                    if ("string" != typeof t) return !1;
                    var n = /^[0-9a-f]+$/;
                    if (hextets = t.split(":"), colons = t.match(/::/), null != colons && t.match(/::/g).length > 1) return !1;
                    if (":" == t[0] && (null == colons || null != colons && 0 != colons.index)) return !1;
                    if (":" == t[t.length - 1] && (null == colons || null != colons && colons.index != t.length - 2)) return !1;
                    if (3 > hextets.length) return !1;
                    var i = 9 == hextets.length && null != colons && (0 == colons.index || colons.index == t.length - 2);
                    if (hextets.length > 8 && !i) return !1;
                ...
                ip: function(t, e, r) {
                    return i.ipv4(t, e, r) || i.ipv6(t, e, r)
                }
            },
            a = function() {
                throw new Error("Validator `" + this.name + "` is not defined!")
        ...
        function o(t, e, r) {
            this.name = t, this.fn = e, this.passes = null, this._customMessage = void 0, this.async = r
        }
        o.prototype = {
            validate: function(t, e, r, n) {
                var i = this;
                if (this._setValidatingData(r, t, e), "function" == typeof n) {
                    this.callback = n;
                    var a = function(t, e) {
                        i.response(t, e)
                    };
                    return this.async ? this._apply(t, e, r, a) : a(this._apply(t, e, r))
                }
                return this._apply(t, e, r)
            },
            _apply: function(t, e, r, n) {
                return (this.isMissed() ? a : this.fn).apply(this, [t, e, r, n])
            },
            _setValidatingData: function(t, e, r) {
                this.attribute = t, this.inputValue = e, this.ruleValue = r
            },
            getParameters: function() {
                var t = [];
                return "string" == typeof this.ruleValue && (t = this.ruleValue.split(",")), "number" == typeof this.ruleValue && t.push(this.ruleValue), this.ruleValue instanceof Array && (t = this.ruleValue), t
            },
            getSize: function() {
                var t = this.inputValue;
                return t instanceof Array ? t.length : "number" == typeof t ? t : this.validator._hasNumericRule(this.attribute) ? parseFloat(t, 10) : t.length
            },
            _getValueType: function() {
                return "number" == typeof this.inputValue || this.validator._hasNumericRule(this.attribute) ? "numeric" : "string"
            },
            response: function(t, e) {
                this.passes = void 0 === t || !0 === t, this._customMessage = e, this.callback(this.passes, e)
            },
        ...
        var s = {
            ...
            implicitRules: ["required", "required_if", "required_unless", "required_with", "required_with_all", "required_without", "required_without_all", "accepted", "present"],
            make: function(t, e) {
                var r = this.isAsync(t),
                    n = new o(t, i[t], r);
                return n.setValidator(e), n
            },
            isAsync: function(t) {
                for (var e = 0, r = this.asyncRules.length; e < r; e++)
    ...
    117: function(t, e, r) {
        ...
        var i = {
            ...
            _setRuleMessage: function(t, e, r) {
                this._load(t), void 0 === r && (r = this.messages[t].def), this.messages[t][e] = r
            },
            _load: function(t) {
                if (!this.messages[t]) try {
                    var e = r(120)("./" + t);
                    this._set(t, e)
                } catch (t) {}
            },
            ...
            _make: function(t) {
                return this._load(t), new n(t, this.messages[t])
            }
        };
        t.exports = i
    },
    118: function(t, e, r) {
        var n = r(56),
            i = function(t, e) {
                this.lang = t, this.messages = e, this.customMessages = {}, this.attributeNames = {}
            };
        i.prototype = {
            constructor: i,
            ...
            _getAttributeName: function(t) {
                var e = t;
                return this.attributeNames.hasOwnProperty(t) ? this.attributeNames[t] : (this.messages.attributes.hasOwnProperty(t) && (e = this.messages.attributes[t]), this.attributeFormatter && (e = this.attributeFormatter(e)), e)
            },
            all: function() {
                return this.messages
            },
            render: function(t) {
                ...
                return n.replacements[t.name] ? n.replacements[t.name].apply(this, [e, t]) : this._replacePlaceholders(t, e, {})
            },
            _getTemplate: function(t) {
                for (var e, r = this.messages, n = r.def, i = this.customMessages, a = [t.name + "." + t.attribute, t.name], o = 0; o < a.length; o++) {
                    if (e = a[o], i.hasOwnProperty(e)) {
                        n = i[e];
                        break
                    }
                ...
                return "object" == typeof n && (n = n[t._getValueType()]), n
            },
            _replacePlaceholders: function(t, e, r) {
                var n, i;
                if (r.attribute = this._getAttributeName(t.attribute), r[t.name] = r[t.name] || t.getParameters().join(","), "string" == typeof e && "object" == typeof r)
                    for (i in n = e, r) n = n.replace(new RegExp(":" + i, "g"), r[i]);
                return n
            }
        }, t.exports = i
    },
    ...
    120: function(t, e, r) {
        ...
        i.keys = function() {
            return Object.keys(n)
        }, i.resolve = a, t.exports = i, i.id = 120
    },
    121: function(t, e) {
        var r = function() {
            this.errors = {}
        ...
        r.prototype = {
            constructor: r,
            add: function(t, e) {
                this.has(t) || (this.errors[t] = []), -1 === this.errors[t].indexOf(e) && this.errors[t].push(e)
            },
            get: function(t) {
    ...
    122: function(t, e) {
        function r(t, e) {
            this.onResolvedAll = e, this.onFailedOne = t, this.resolvers = {}, this.resolversCount = 0, this.passed = [], this.failed = [], this.firing = !1
        }
        r.prototype = {
            add: function(t) {
            ...
            resolve: function(t) {
                ...
                !0 === e.passes ? this.passed.push(e) : !1 === e.passes && (this.failed.push(e), this.onFailedOne(e)), this.fire()
            },
            isAllResolved: function() {
                return this.passed.length + this.failed.length === this.resolversCount
            },
    ...
    123: function(t, e, r) {
        ...
        var s = function() {
            function t() {
                ...
                if (function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), "" === e.paywallUrl || void 0 === e.paywallUrl) throw "Required config: paywallUrl";
                this.paywallUrl = e.paywallUrl;
                var r = this.getSystemConfig(e.paywallUrl),
                    n = a({}, r, e);
                this.updateKeys(n)
            }
            return o(t, [{
                ...
                value: function() {
                    var t = this;
                    if (null !== localStorage.getItem("subscription_config")) return this.getConfigFromLocalStorage();
                    this.getConfigFromApi().then(function(e) {
                        t.updateKeys(e)
                    })
                }
            }, {
                ...
                key: "getConfigFromApi",
                value: function() {
                    var t, e = (t = i.a.mark(function t() {
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return t.prev = 0, t.next = 3, fetch(this.paywallUrl + "/api/v1/config").then(function(t) {
                                        return t.json()
                                    }).then(function(t) {
                                        var e = t.data;
                                        return localStorage.setItem("subscription_config", JSON.stringify(e)), e
                                    });
                                case 3:
                                    return t.abrupt("return", t.sent);
                                case 6:
                                    return t.prev = 6, t.t0 = t.catch(0), console.log(t.t0), t.abrupt("return", {});
                                case 10:
                                case "end":
                                    return t.stop()
                            }
                ...
                value: function(t) {
                    ...
                    t && Object.keys(t).forEach(function(r) {
                        var n = t[r];
                        r = r.replace(/([-_][a-z])/gi, function(t) {
    ...
    124: function(t, e, r) {
        ...
        t.exports = function(t) {
            ...
            n = n.concat(t), i = new RegExp("(" + n.join("|") + ")", "ig")
        }
    },
    125: function(t, e) {
        t.exports = ["bot", "crawl", "yahoo", "AppEngine-Google", "cXensebot", "facebookexternalhit", "Feedfetcher-Google", "Google Wireless Transcoder", "Google Favicon", "Google Page Speed Insights", "Mediapartners-Google", "g00g1e\\.net", "developers\\.google\\.com\\/\\+\\/web\\/snippet\\/"]
    },
    243: function(t, e, r) {
        "use strict";
        ...
        var i = "undefined" != typeof window && window.atob && window.atob.bind(window) || function(t) {
            ...
            for (var r, i, a = 0, o = 0, s = ""; i = e.charAt(o++); ~i && (r = a % 4 ? 64 * r + i : i, a++ % 4) ? s += String.fromCharCode(255 & r >> (-2 * a & 6)) : 0) i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(i);
            return s
        };
        ...
        function a(t) {
            ...
            try {
                return decodeURIComponent(i(e).replace(/(.)/g, function(t, e) {
        ...
        o.prototype = new Error, o.prototype.name = "InvalidTokenError", e.a = function(t, e) {
            if ("string" != typeof t) throw new o("Invalid token specified");
            var r = !0 === (e = e || {}).header ? 0 : 1;
            try {
                return JSON.parse(a(t.split(".")[r]))
            } catch (t) {
    ...
    244: function(t, e, r) {
        ...
        function a(t) {
            return n.enc.Base64.stringify(t).replace(/=+$/, "").replace(/\+/g, "-").replace(/\//g, "_")
        }

        function o(t) {
            return a(n.enc.Utf8.parse(JSON.stringify(t)))
        }
        t.exports = function(t, e, r = {}) {
            const s = Object.assign(i, r);
            if ("HS256" !== s.alg && "JWT" !== s.typ) throw new Error("jwt-encode only support the HS256 algorithm and the JWT type of hash");
            const u = o(s),
                c = o(t);
            let l = `${u}.${c}`;
            return `${u}.${c}.${l = a(l = n.HmacSHA256(l, e))}`
        }
    },
    245: function(t, e) {
        var r, n, i = i || function(t, e) {
            var r = {},
                n = r.lib = {},
                i = function() {},
                a = n.Base = {
                ...
                h = n.BufferedBlockAlgorithm = a.extend({
                    ...
                    _process: function(e) {
                        var r = this._data,
                            ...
                            a = this.blockSize,
                            s = i / (4 * a);
                        if (e = (s = e ? t.ceil(s) : t.max((0 | s) - this._minBufferSize, 0)) * a, i = t.min(4 * e, i), e) {
                            for (var u = 0; u < e; u += a) this._doProcessBlock(n, u);
        ...
        ! function(t) {
            for (var e = i, r = (a = e.lib).WordArray, n = a.Hasher, a = e.algo, o = [], s = [], u = function(t) {
                    return 4294967296 * (t - (0 | t)) | 0
                }, c = 2, l = 0; 64 > l;) {
                var h;
                t: {
                    h = c;
                    for (var f = t.sqrt(h), p = 2; p <= f; p++)
                        if (!(h % p)) {
                            h = !1;
                            break t
                        } h = !0
                }
                h && (8 > l && (o[l] = u(t.pow(c, .5))), s[l] = u(t.pow(c, 1 / 3)), l++), c++
            }
            var d = [];
            a = a.SHA256 = n.extend({
                _doReset: function() {
                ...
                _doProcessBlock: function(t, e) {
                    for (var r = this._hash.words, n = r[0], i = r[1], a = r[2], o = r[3], u = r[4], c = r[5], l = r[6], h = r[7], f = 0; 64 > f; f++) {
                        if (16 > f) d[f] = 0 | t[e + f];
                        else {
                            var p = d[f - 15],
                                g = d[f - 2];
                            d[f] = ((p << 25 | p >>> 7) ^ (p << 14 | p >>> 18) ^ p >>> 3) + d[f - 7] + ((g << 15 | g >>> 17) ^ (g << 13 | g >>> 19) ^ g >>> 10) + d[f - 16]
                        }
                        p = h + ((u << 26 | u >>> 6) ^ (u << 21 | u >>> 11) ^ (u << 7 | u >>> 25)) + (u & c ^ ~u & l) + s[f] + d[f], g = ((n << 30 | n >>> 2) ^ (n << 19 | n >>> 13) ^ (n << 10 | n >>> 22)) + (n & i ^ n & a ^ i & a), h = l, l = c, c = u, u = o + p | 0, o = a, a = i, i = n, n = p + g | 0
                    }
                    r[0] = r[0] + n | 0, r[1] = r[1] + i | 0, r[2] = r[2] + a | 0, r[3] = r[3] + o | 0, r[4] = r[4] + u | 0, r[5] = r[5] + c | 0, r[6] = r[6] + l | 0, r[7] = r[7] + h | 0
                },
            ...
            e.SHA256 = n._createHelper(a), e.HmacSHA256 = n._createHmacHelper(a)
        }(Math), n = (r = i).enc.Utf8, r.algo.HMAC = r.lib.Base.extend({
                init: function(t, e) {
                    t = this._hasher = new t.init, "string" == typeof e && (e = n.parse(e));
                    var r = t.blockSize,
                        i = 4 * r;
                    e.sigBytes > i && (e = t.finalize(e)), e.clamp();
                    for (var a = this._oKey = e.clone(), o = this._iKey = e.clone(), s = a.words, u = o.words, c = 0; c < r; c++) s[c] ^= 1549556828, u[c] ^= 909522486;
            ...
            function() {
                ...
                t.enc.Base64 = {
                    stringify: function(t) {
                        ...
                        t.clamp(), t = [];
                        for (var i = 0; i < r; i += 3)
                            for (var a = (e[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 16 | (e[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255) << 8 | e[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, o = 0; 4 > o && i + .75 * o < r; o++) t.push(n.charAt(a >>> 6 * (3 - o) & 63));
                        if (e = n.charAt(64))
                        ...
                        for (var i = [], a = 0, o = 0; o < r; o++)
                            if (o % 4) {
                                var s = n.indexOf(t.charAt(o - 1)) << o % 4 * 2,
                                    u = n.indexOf(t.charAt(o)) >>> 6 - o % 4 * 2;
            ...
            function(t) {
                ...
                Utf8: i.enc.Utf8,
                Latin1: i.enc.Latin1
            }, e.SHA256 = i.SHA256, e.HmacSHA256 = i.HmacSHA256
    },
    26: function(t, e, r) {
        "use strict";
        e.d = function() {
            ...
            var r = "paywall." + e,
                i = new Event(r);
            n(["Event fired: " + r]), t.dispatchEvent(i)
        };
        var n = function(t) {
            var e, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "info";
            "undefined" != typeof paywallConfig && void 0 !== paywallConfig.debug && paywallConfig.debug && (e = console)[r].apply(e, ["Paywall |"].concat(function(t) {
                if (Array.isArray(t)) {
    ...
    455: function(t, e, r) {
        ...
        var p = {
            ...
            d = function() {
                function t() {
                    ...
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this.config = e, void 0 === e.element ? (document.body.classList.contains("paywall") || document.body.classList.add("paywall"), this.element = document.querySelector(".paywall")) : this.element = e.element, this.cookie = "paywall_user", this.version = "1.0.0", this.subscriptionData = "subscription_data_v" + this.version
                }
                return u(t, [{
                    key: "user",
                    value: function() {
                        var t = l.get(this.cookie);
                        if (t) try {
                            return Object(o.a)(t)
                        } catch (t) {
                            console.log("AUTH FAILED", t), this.logout()
                        }
                        return !1
                    }
                }, {
                            ...
                            return i.a.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        ...
                                        return localStorage.removeItem(this.subscriptionData), t.next = 4, this.getSubscriptionData().then(function(t) {
                                            return Object(a.d)("User is subscribed:", e.user() && t.is_active), e.user() && t.is_active
                                        }).catch(function(t) {
                                            return e.user() && e.user().subscribed
                                        });
                                    case 4:
                                        return t.abrupt("return", t.sent);
                                    case 7:
                                        return t.abrupt("return", this.user() && this.user().subscribed);
                                    case 8:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    key: "login",
                    value: function(t) {
                        l.set(this.cookie, h(t, Object(a.a)()), {
                            domain: Object(a.a)(),
                            expires: 365
                        })
                    }
                    ...
                    value: function(t) {
                        var e = new f(t, p);
                        return !e.fails() || (error("User object no válido: ", e.errors.all(), t), !1)
                    }
                }, {
                    key: "isDev",
                    value: function() {
                    ...
                    value: function(t) {
                        var e = this.user();
                        e.subscribed = t, e.checkSubscription = !1, l.set(this.cookie, h(e, Object(a.a)()), {
                            domain: Object(a.a)(),
                            expires: 365
                        })
                    }
                    ...
                    value: function() {
                        var t = c(i.a.mark(function t() {
                            ...
                            return i.a.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        if (e = {}, null === localStorage.getItem(this.subscriptionData) || void 0 === localStorage.getItem(this.subscriptionData) || "undefined" === localStorage.getItem(this.subscriptionData)) {
                                            t.next = 6;
                                            break
                                        }
                                        if (!(e = JSON.parse(localStorage.getItem(this.subscriptionData)))) {
                                            t.next = 6;
                                            break
                                        }
                                        if (!(null !== e.expiration && e.expiration > (new Date).getTime() - 36e5)) {
                                            t.next = 6;
                                            break
                                        }
                                        return t.abrupt("return", e);
                                    case 6:
                                        return t.next = 8, fetch(this.config.paywallUrl + "/subscription-data", {
                                            credentials: "include",
                                            mode: "cors"
                                        }).then(function(t) {
                                            return t.json()
                                            ...
                                            return void 0 !== (e = s({}, t, {
                                                expiration: (new Date).getTime()
                                            })).is_active && null !== e.is_active ? (localStorage.setItem(r.subscriptionData, JSON.stringify(e)), r.addSubscribed(e.is_active)) : r.addSubscribed(!1), e
                                        }).catch(function(t) {
                                            console.log(t), e = {
                                                expiration: (new Date).getTime()
                                            }, localStorage.setItem(r.subscriptionData, JSON.stringify(e))
                                        });
                                    case 8:
        ...
        var k = function() {
                function t() {
                    ...
                    this.config = _({}, {
                        isPreview: !1,
                        events: []
                    }, e), this.element = e.element, this.auth = r, this.history = n, this.version = "1.0.0", this.meterCookie = "paywall_meter", this.meterLastCheckCookie = "paywall_meter_last_check", this.walls = this.getWalls(), isNaN(b.a.get(this.meterCookie)) ? this.meter = 0 : this.meter = parseInt(b.a.get(this.meterCookie)) || this.meter, this.showingWall = !1, this.wall = null, this.customKey = null, Object(a.d)("Paywall config:", this.config)
                }
                return x(t, [{
                    key: "check",
                    value: function() {
                        var t = this;
                        Object(a.c)(this.element, "checking"), this.shouldCheck() && (this.saveUrl(), this.auth.isSubscribed().then(function(e) {
                            Object(a.d)("User is subscribed:", e), !1 === e ? ("premium" === t.config.type && t.showPaywall("exclusivo", "Contenido Premium"), t.metered().then(function(e) {
                                Object(a.d)(e), t.walls.filter(function(e) {
                                    return e.key < t.meter
                                }).forEach(function(e) {
                                    void 0 !== e && t.showWall(e, "Metered")
                                })
                            }).catch(a.b)) : t.metered().then(function(t) {
                                Object(a.d)(t)
                            }).catch(a.b)
                        })), setTimeout(function() {
                            Object(a.c)(t.element, "checked")
                        }, 1)
                    }
                }, {
                    key: "showWall",
                    value: function(t) {
                        ...
                        switch (t.name) {
                            case "paywall":
                                this.showPaywall(null, e);
                                break;
                            case "loginwall":
                                this.showLoginwall(e);
                                break;
                            case "customwall":
                                this.showCustomWall(t.key, e)
                        }
                    }
                }, {
                    key: "showPaywall",
                    value: function(t) {
                        var e = this,
                            r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                        if ("not_blocking" !== this.config.type) {
                            Object(a.d)("[" + (r || "sin descripción") + "]");
                            try {
                                localStorage.setItem("subscription_data_v" + this.version, null)
                            } catch (t) {}
                            this.showingWall || (this.showingWall = !0, Object(a.c)(this.element, "paywall"), Object(a.d)("Paywall [" + (r || "sin descripción") + "]"), setTimeout(function() {
                                window.location = e.config.paywallUrl + "?limit=true" + ("limit" !== t && "" !== t && t ? "&msg=" + t : "") + "&continue=" + document.URL
                            }, 100))
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.auth.isLogged() || this.showingWall || "not_blocking" === this.config.type || (Object(a.c)(this.element, "loginwall"), this.showingWall = !0, this.wall = "loginwall", Object(a.d)("Loginwall [" + (t || "sin descripción") + "]"), dataLayer.push({
                            event: "gaEvent",
                            eventCategory: "subscriptions",
                            eventAction: "loginwall",
                            eventLabel: "hard"
                    ...
                    value: function(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                        this.showingWall || (Object(a.d)("Customwall [" + (e || "sin descripción") + "]"), Object(a.c)(this.element, "customwall:" + t), this.showingWall = !0)
                    }
                }, {
                    key: "shouldCheck",
                    value: function() {
                        return !this.isPreview() && !v(navigator.userAgent) && !this.isNavigationRole() && this.isNodeEnabled()
                    }
                }, {
                    key: "isPaywallDisabled",
                    value: function() {
                    ...
                    key: "isNodeEnabled",
                    value: function() {
                        var t = this.config.allowedContentTypes.indexOf(this.config.contentType) >= 0 && "free_access" !== this.config.type;
                        return Object(a.d)("Node enabled:", t), t
                    }
                }, {
                    key: "getWalls",
                    value: function() {
                        var t = [{
                            ...
                            e = this.config.events.filter(function(t) {
                                return t.includes("customwall")
                            }).map(function(t) {
                                var e = t.split(":"),
                                    r = w(e, 2),
                                    n = r[0],
                    ...
                    value: function() {
                        var t = this;
                        return new Promise(function(e, r) {
                            var n = b.a.get(t.meterLastCheckCookie) ? new Date(b.a.get(t.meterLastCheckCookie)) : new Date,
                                i = new Date,
                                a = new Date(i.getFullYear(), i.getMonth() + 1, i.getDate(), 23, 59),
                                o = Math.floor((i - n) / 864e5),
                                s = Math.floor(t.meter / 30) * o;
                            if (t.history.setUrl()) {
                                t.meter = t.meter - s, t.meter++;
                                var u = {
                                    expires: a,
                                    domain: t.config.cookieDomain,
                                    safeSite: "None",
                                    secure: !0
                                };
                                b.a.set(t.meterCookie, t.meter, u), (o > 0 || void 0 === b.a.get(t.meterLastCheckCookie)) && b.a.set(t.meterLastCheckCookie, i, u)
                            }
                            e("Meter: " + t.meter)
                        })
                    }
                    ...
                    key: "isNavigationRole",
                    value: function() {
                        return !!(this.auth.isLogged() && this.auth.user() && (this.auth.user().email.indexOf("@losandes.com.ar") > 0 || this.auth.user().email.indexOf("@diaadia.com.ar") > 0 || this.auth.user().email.indexOf("@cimeco.com") > 0 || this.auth.user().email.indexOf("@lavozdelinterior.com.ar") > 0))
                    }
                }, {
                    key: "saveUrl",
                    value: function() {
                        ...
                        b.a.set("paywall_last_article", window.location.pathname, t), b.a.set("paywall_last_article_full", window.location.href, t), b.a.set("paywall_last_article_domain", window.location.host, t), "premium" === this.config.type ? b.a.set("paywall_last_article_premium", window.location.pathname, t) : b.a.remove("paywall_last_article_premium", {
                            path: "/",
                            domain: Object(a.a)()
                        })
                    }
        ...
        var C = function() {
            function t() {
                ...
                this.config = O({}, {
                    ...
                    async: !1,
                    events: [],
                    paywallUrl: "https://suscripcion.lavoz.com.ar"
                }, e), document.body.classList.add("paywall"), this.element = document.querySelector(".paywall"), Object(a.c)(this.element, "ready"), "object" === (void 0 === r ? "undefined" : A(r)) && Array.isArray(r.queue) && (this.queue = r.queue, this.processQueue()), Object(a.d)("Config: ", this.config), this.auth = n, this.history = i, this.paywall = new k(O({
                    element: this.element
                }, this.config), this.auth, this.history), this.config.async || this.paywall.check(), this.cookie = "paywall_user"
            }
            return S(t, [{
                key: "signIn",
                value: function(t) {
                    this.auth.validate(t) && (Object(a.d)("User logged in"), t.checkSubscription = !0, this.auth.login(t))
                }
            }, {
                key: "signOff",
                value: function() {
                ...
                key: "infiniteScroll",
                value: function() {
                    Object(a.d)("Infinite scroll"), Object(a.c)(this.paywall.element, "infiniteScroll")
                }
            }, {
                key: "registerEvent",
                value: function(t, e) {
                    this.config.events.push(t), this.element.addEventListener("paywall." + t, e)
                }
            }, {
                key: "check",
                value: function() {
                ...
                value: function(t) {
                    ...
                    e.innerHTML = "";
                    var r = document.createElement("iframe");
                    r.setAttribute("id", "paywall-subscription"), r.setAttribute("width", "100%"), r.setAttribute("height", "800"), r.setAttribute("style", "width: 1px; min-width: 100%; border: 0;"), r.setAttribute("sandbox", "allow-same-origin allow-scripts allow-modals allow-forms allow-top-navigation"), e.appendChild(r), r.src = this.config.paywallUrl + "/mi-suscripcion"
                }
            }, {
                key: "viewSubscriptionData",
                value: function() {
                    var t, e = (t = i.a.mark(function t(e) {
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return t.t0 = e, t.next = 3, this.auth.getSubscriptionData();
                                case 3:
        ...
        C.prototype.processQueue = function() {
            var t = this;
            for (Object(a.d)("Processing Queue"); this.queue.length;) {
                var e = j(this.queue.shift()),
                    r = e[0],
                    n = e.slice(1);
                ! function() {
                    switch (r) {
                        case "addEventListener":
                            t.registerEvent.apply(t, P(n));
                            break;
                        case "invoke":
                            var e = j(n),
                                i = e[0],
                            ...
                            setTimeout(function() {
                                try {
                                    var e;
                                    if (a)(e = t[i]).call.apply(e, [t].concat(P(a)));
                                    else t[i].call(t)
                                } catch (t) {}
                            }, 1)
                    }
        ...
        var E = O({}, {
                allowedContentTypes: ["nota_periodistica"]
            }, window.paywallConfig),
            R = new g.a(E),
            T = new d(R),
            L = new m.a;
        window.dataLayer = window.dataLayer || [], window.paywall = window.paywall || {}, window.paywall.queue = window.paywall.queue || [], window.paywall.queue.push = function() {
            return Array.prototype.push.apply(this, arguments), setTimeout(window.paywall.processQueue(), 1), this.length
        }, window.paywall = new C(R, paywall, T, L)
    },
    55: function(t, e, r) {
        var n, i;
        ! function(a) {
            if (void 0 === (i = "function" == typeof(n = a) ? n.call(e, r, e, t) : n) || (t.exports = i), !0, t.exports = a(), !!0) {
                var o = window.Cookies,
                    s = window.Cookies = a();
                s.noConflict = function() {
                    return window.Cookies = o, s
